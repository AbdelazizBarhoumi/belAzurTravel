...
export default function EventDetail() {
        ...
        return (
            <PageShell>
                <div className="py-12 text-center">
                    <h1 className="mb-4 font-serif text-3xl font-bold text-foreground">{t('events.detail.notFound')}</h1>
                    <Button asChild>
    ...
    return (
        <PageShell breadcrumbs={[{ label: t('common.home'), href: '/' }, { label: t('nav.events'), href: '/events' }, { label: localizeText(event.title, lang), active: true }]}>
           <motion.div
