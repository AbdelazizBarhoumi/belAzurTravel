...
import { useDestinationBySlug, useHotels, useTours } from '@/hooks/useCatalog';
    ...
    const relatedTours = tours.filter(
        (tour) =>
            localize(tour.location, lang)
                .toLowerCase()
                .includes(localize(destination.country, lang).toLowerCase()) ||
            localize(tour.location, 'en')
                .toLowerCase()
                .includes(localize(destination.country, 'en').toLowerCase()),
    );
                    ...
                    <div className="mb-8">
                        <Breadcrumb
                            items={[
                                ...
                                {
                                    label: localize(destination.name, lang),
                                    active: true,
                                },
                            ]}
                        />
