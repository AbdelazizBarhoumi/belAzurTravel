...
const EMPTY: PolicyData = {
    title: { en: 'Purchase Policy', fr: "Politique d'achat", ar: 'سياسة الشراء' },
...
export default function AdminSiteSettingsPurchasePolicy() {
        ...
        autosaveTimerRef.current = window.setTimeout(async () => {
            try {
                ...
                await apiFetch('/api/site-settings', {
                    method: 'PUT',
                    body: JSON.stringify({ content: { ...content, purchase_policy: data } }),
                });
    ...
    if (loading) {
        return (
            <AdminLayout title={t('nav.purchase-policy')} subtitle={t('nav.settings')}>
