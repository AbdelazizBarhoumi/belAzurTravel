...
export default function AdminSiteSettingsPrivacyPolicy() {
    ...
    useEffect(() => {
        ...
        const stored = content?.privacy_policy as PolicyData | undefined;
        if (stored) {
    ...
    return (
        <AdminLayout
            ...
            subtitle="Dedicated privacy policy page content"
            actions={
