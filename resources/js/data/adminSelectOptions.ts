...
export const VISA_REGIONS: LocalizedOption[] = [
    { value: 'schengen', label: { en: 'Schengen Area', fr: 'Espace Schengen', ar: 'منطقة شنغن' } },
    { value: 'eu', label: { en: 'European Union', fr: 'Union Européenne', ar: 'الاتحاد الأوروبي' } },
    { value: 'gcc', label: { en: 'Gulf Cooperation Council (GCC)', fr: 'Conseil de Coopération du Golfe (CCG)', ar: 'مجلس التعاون الخليجي' } },
    { value: 'african_union', label: { en: 'African Union', fr: 'Union Africaine', ar: 'الاتحاد الأفريقي' } },
    { value: 'asean', label: { en: 'ASEAN', fr: 'ASEAN', ar: 'أسيان' } },
    { value: 'americas', label: { en: 'Americas', fr: 'Amériques', ar: 'الأمريكيتين' } },
    { value: 'uk', label: { en: 'United Kingdom', fr: 'Royaume-Uni', ar: 'المملكة المتحدة' } },
...
export const CABIN_CLASSES: LocalizedOption[] = [
    ...
    { value: 'premium_economy', label: { en: 'Premium Economy', fr: 'Économique Premium', ar: 'بريميوم اقتصادية' } },
    { value: 'business', label: { en: 'Business', fr: 'Affaires', ar: 'رجال الأعمال' } },
    { value: 'first', label: { en: 'First Class', fr: 'Première Classe', ar: 'الدرجة الأولى' } },
];

// --- Flight Stops ---
export const FLIGHT_STOPS: LocalizedOption[] = [
    { value: 'direct', label: { en: 'Direct', fr: 'Direct', ar: 'مباشر' } },
    { value: '1_stop', label: { en: '1 Stop', fr: '1 Escale', ar: 'توقف واحد' } },
    { value: '2_stops', label: { en: '2+ Stops', fr: '2+ Escales', ar: 'توقفان أو أكثر' } },
];
...
export const TRANSMISSION_TYPES: LocalizedOption[] = [
    ...
    { value: 'semi_automatic', label: { en: 'Semi-Automatic', fr: 'Semi-Automatique', ar: 'شبه أوتوماتيك' } },
];
...
export const BEST_TIME_OPTIONS: LocalizedOption[] = [
    ...
    { value: 'all_year', label: { en: 'All Year', fr: 'Toute l\'année', ar: 'على مدار السنة' } },
];
...
export const LANGUAGES: LocalizedOption[] = [
    ...
    { value: 'swahili', label: { en: 'Swahili', fr: 'Swahili', ar: 'السواحلية' } },
];
...
export const CURRENCIES: LocalizedOption[] = [
    ...
    { value: 'DZD', label: { en: 'Algerian Dinar (DZD)', fr: 'Dinar Algérien (DZD)', ar: 'الدينار الجزائري (DZD)' } },
];

// --- Weather / Climate Types ---
export const WEATHER_OPTIONS: LocalizedOption[] = [
    { value: 'tropical', label: { en: 'Tropical', fr: 'Tropical', ar: 'استوائي' } },
    { value: 'mediterranean', label: { en: 'Mediterranean', fr: 'Méditerranéen', ar: 'متوسطي' } },
    { value: 'desert', label: { en: 'Desert', fr: 'Désertique', ar: 'صحراوي' } },
    { value: 'continental', label: { en: 'Continental', fr: 'Continental', ar: 'قاري' } },
    { value: 'temperate', label: { en: 'Temperate', fr: 'Tempéré', ar: 'معتدل' } },
    { value: 'monsoon', label: { en: 'Monsoon', fr: 'Mousson', ar: 'الرياح الموسمية' } },
    ...
    { value: 'subtropical', label: { en: 'Subtropical', fr: 'Subtropical', ar: 'شبه استوائي' } },
];

// --- Airlines ---
export const AIRLINE_NAMES: LocalizedOption[] = [
    { value: 'tunisair', label: { en: 'Tunisair', fr: 'Tunisair', ar: 'الخطوط التونسية' } },
    { value: 'air_france', label: { en: 'Air France', fr: 'Air France', ar: 'الخطوط الجوية الفرنسية' } },
    { value: 'emirates', label: { en: 'Emirates', fr: 'Emirates', ar: 'طيران الإمارات' } },
    { value: 'qatar_airways', label: { en: 'Qatar Airways', fr: 'Qatar Airways', ar: 'الخطوط الجوية القطرية' } },
    { value: 'turkish_airlines', label: { en: 'Turkish Airlines', fr: 'Turkish Airlines', ar: 'الخطوط الجوية التركية' } },
    { value: 'royal_air_maroc', label: { en: 'Royal Air Maroc', fr: 'Royal Air Maroc', ar: 'الخطوط الملكية المغربية' } },
    { value: 'egyptair', label: { en: 'EgyptAir', fr: 'EgyptAir', ar: 'مصر للطيران' } },
    { value: 'saudi_arabian_airlines', label: { en: 'Saudia', fr: 'Saudia', ar: 'الخطوط الجوية العربية السعودية' } },
    { value: 'lufthansa', label: { en: 'Lufthansa', fr: 'Lufthansa', ar: 'لوفتهانزا' } },
    { value: 'british_airways', label: { en: 'British Airways', fr: 'British Airways', ar: 'الخطوط الجوية البريطانية' } },
    { value: 'klm', label: { en: 'KLM', fr: 'KLM', ar: 'ك إل إم' } },
    { value: 'italy_airways', label: { en: 'ITA Airways', fr: 'ITA Airways', ar: 'إيطاليا للطيران' } },
    { value: 'iberia', label: { en: 'Iberia', fr: 'Iberia', ar: 'إيبيريا' } },
    { value: 'ryanair', label: { en: 'Ryanair', fr: 'Ryanair', ar: 'رايان إير' } },
    { value: 'easyjet', label: { en: 'EasyJet', fr: 'EasyJet', ar: 'إيزي جيت' } },
    { value: 'swiss', label: { en: 'Swiss', fr: 'Swiss', ar: 'السويسرية' } },
    { value: 'ethiopian_airlines', label: { en: 'Ethiopian Airlines', fr: 'Ethiopian Airlines', ar: 'الخطوط الجوية الإثيوبية' } },
    { value: 'saudia', label: { en: 'Saudia', fr: 'Saudia', ar: 'طيران السعودية' } },
    { value: 'kuwait_airways', label: { en: 'Kuwait Airways', fr: 'Kuwait Airways', ar: 'الخطوط الجوية الكويتية' } },
    { value: 'gulf_air', label: { en: 'Gulf Air', fr: 'Gulf Air', ar: 'طيران الخليج' } },
];
