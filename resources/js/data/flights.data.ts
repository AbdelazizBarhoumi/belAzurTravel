...
export const flightsData: FlightItem[] = [
    {
        ...
        baggage: {
            fr: '1 bagage cabine + 1 bagage enregistré',
            ar: '1 حقيبة يد + 1 حقيبة مسجلة',
            en: '1 cabin + 1 checked bag',
        },
        refund: {
            fr: 'Remboursable partiellement',
            ar: 'قابل للاسترداد جزئيًا',
    ...
    },
    {
        ...
        aircraft: {
            fr: 'Boeing 787-9 Dreamliner',
            ar: 'بوينغ 787-9 دريملاينر',
            en: 'Boeing 787-9 Dreamliner',
        },
        baggage: {
            fr: '2 bagages enregistrés',
            ar: '2 حقيبتان مسجلتان',
            en: '2 checked bags',
        },
        refund: {
            fr: 'Remboursable avec frais',
            ar: 'قابل للاسترداد مقابل رسوم',
