...
/**
* @see \App\Http\Controllers\Api\HotelImageController::show
 * @see app/Http/Controllers/Api/HotelImageController.php:17
 * @route '/api/hotels/images/{token}'
 */
 ...
 */
    ...
    show.form = showForm
const HotelImageController = { show }

export default HotelImageController