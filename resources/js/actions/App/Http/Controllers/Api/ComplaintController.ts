 ...
 * @see app/Http/Controllers/Api/ComplaintController.php:14
 ...
 * @see app/Http/Controllers/Api/ComplaintController.php:34
 * @route '/api/client/complaints'
 */
...
const ComplaintController = { index, show, store }
