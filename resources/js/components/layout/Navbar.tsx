                    ...
                    {topEntries.map((entry) => {
                        ...
                        return (
                            <Link
                                key={entry.pageKey}
                                to={page.href}
                                className={`inline-flex h-10 items-center px-3 text-sm font-medium transition-colors ${
                                    isActiveSection(page.href)
                                        ? 'text-primary'
                                                                ...
                                                                (it, i) => (
                                                                    <li key={i}>
                                                                        <Link
                                                                            ...
                                                                            className="block rounded px-2 py-1 text-xs text-muted-foreground transition-colors hover:text-foreground"
                                                                        >
                                                                            {resolveLabel(
                                                                                it.label,
                                                                            )}
