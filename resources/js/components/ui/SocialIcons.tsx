...
export const TiktokIcon = (props: IconProps) => (
    <Icon icon="logos:tiktok-icon" width="1em" height="1em" style={{ width: props.width, height: props.height, ...props.style }} className={props.className} />
);
