                            ...
                            >
                                ...
                                >
                                    <div className="relative h-48 overflow-hidden bg-muted">
                                        ...
                                        <div className="absolute left-3 top-3 rounded-full bg-secondary px-3 py-1 text-xs font-bold text-secondary-foreground">
                                            {event.category_key
                                                ? localizeText(
                                                      event.category_key,
                                                      lang,
                                    ...
                                    <div className="p-5">
                                        ...
                                        <h3 className="mt-1 line-clamp-1 font-serif text-lg font-bold">
