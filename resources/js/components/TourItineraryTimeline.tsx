...
export function TourItineraryTimeline({ itinerary }: TourItineraryTimelineProps) {
    return (
        <section className="rounded-2xl border border-border bg-card p-6">
            <h3 className="mb-5 font-serif text-xl font-bold text-foreground">Itinerary timeline</h3>
            <div className="space-y-5">
                {itinerary.map((step, index) => (
                    ...
                    >
                        ...
                        <div className="pb-5 text-sm leading-relaxed text-foreground">{step}</div>
                    </motion.div>
                ))}
            </div>
        </section>
