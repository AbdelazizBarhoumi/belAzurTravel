...
function Zl(e) {
    (ot.includes(e) || ot.push(e), Xl());
}
function Yl(e) {
    let t = ot.indexOf(e);
    t !== -1 && t > ur && ot.splice(t, 1);
}
function Xl() {
    !lr && !cr && ((cr = !0), queueMicrotask(Kl));
}
function Kl() {
    ((cr = !1), (lr = !0));
    for (let e = 0; e < ot.length; e++) (ot[e](), (ur = e));
    ((ot.length = 0), (ur = -1), (lr = !1));
}
var Pt,
    gt,
    Dt,
...
function uo(e, t) {
    e._x_attributeCleanups &&
        Object.entries(e._x_attributeCleanups).forEach(([n, a]) => {
            (t === void 0 || t.includes(n)) &&
                (a.forEach((r) => r()), delete e._x_attributeCleanups[n]);
        });
}
function nu(e) {
...
var Zr = new MutationObserver(Qr),
    Yr = !1;
function Xr() {
    (Zr.observe(document, {
        subtree: !0,
...
function po() {
    (au(), Zr.disconnect(), (Yr = !1));
}
var Kt = [];
function au() {
    let e = Zr.takeRecords();
    Kt.push(() => e.length > 0 && Qr(e));
    let t = Kt.length;
    queueMicrotask(() => {
        if (Kt.length === t) for (; Kt.length > 0; ) Kt.shift()();
    });
}
function z(e) {
    if (!Yr) return e();
...
function Qr(e) {
    ...
    for (let i = 0; i < e.length; i++)
        if (
            ...
            (e[i].type === 'childList' &&
                (e[i].removedNodes.forEach((s) => {
                    s.nodeType === 1 && s._x_marker && n.add(s);
                }),
                e[i].addedNodes.forEach((s) => {
                    if (s.nodeType === 1) {
                        if (n.has(s)) {
                            n.delete(s);
                            return;
            ...
            let s = e[i].target,
                ...
                l = () => {
                    (a.has(s) || a.set(s, []),
                        a.get(s).push({ name: o, value: s.getAttribute(o) }));
                },
                u = () => {
                    (r.has(s) || r.set(s, []), r.get(s).push(o));
                };
            s.hasAttribute(o) && c === null
                ? l()
                : s.hasAttribute(o)
                  ? (u(), l())
                  : u();
    ...
    for (let i of n) t.some((s) => s.contains(i)) || so.forEach((s) => s(i));
    for (let i of t) i.isConnected && oo.forEach((s) => s(i));
    ((t = null), (n = null), (a = null), (r = null));
}
function mo(e) {
    return wn(At(e));
}
...
var su = {
    ...
    get({ objects: e }, t, n) {
        return t == 'toJSON'
            ? ou
            : Reflect.get(e.find((a) => Reflect.has(a, t)) || {}, t, n);
    },
    set({ objects: e }, t, n, a) {
        const r =
        ...
        return i?.set && i?.get ? i.set.call(a, n) || !0 : Reflect.set(r, t, n);
    },
};
function ou() {
            ...
            Object.entries(Object.getOwnPropertyDescriptors(a)).forEach(
                ([i, { value: s, enumerable: o }]) => {
                    ...
                    typeof s == 'object' && s !== null && s._x_interceptor
                        ? (a[i] = s.initialize(e, c, i))
                        : t(s) && s !== a && !(s instanceof Element) && n(s, c);
                },
            );
        };
    return n(e);
    ...
    return (
        ...
        (a) => {
            if (typeof a == 'object' && a !== null && a._x_interceptor) {
                ...
                n.initialize = (i, s, o) => {
                    let c = a.initialize(i, s, o);
                    return ((n.initialValue = c), r(i, s, o));
                };
            } else n.initialValue = a;
            return n;
        }
    );
}
...
function yo(e, t) {
    ...
    mr(n, e);
    let a = [n, ...At(e)],
        r = typeof t == 'function' ? du(a, t) : hu(a, t, e);
    return uu.bind(null, e, t, r);
}
function du(e, t) {
    return (n = () => {}, { scope: a = {}, params: r = [] } = {}) => {
        let i = t.apply(wn([a, ...e]), r);
        sa(n, i);
    };
}
var Ma = {};
    ...
    let n = Object.getPrototypeOf(async function () {}).constructor,
        ...
        i = (() => {
            try {
                ...
                return (dn(s, t, e), Promise.resolve());
            }
        })();
    return ((Ma[e] = i), i);
}
function hu(e, t, n) {
    let a = mu(t, n);
    return (r = () => {}, { scope: i = {}, params: s = [] } = {}) => {
        ((a.result = void 0), (a.finished = !1));
        let o = wn([i, ...e]);
        if (typeof a == 'function') {
            let c = a(a, o).catch((l) => dn(l, n, t));
            a.finished
                ? (sa(r, a.result, o, s, n), (a.result = void 0))
                : c
                      .then((l) => {
                          sa(r, l, o, s, n);
                      })
...
function sa(e, t, n, a, r) {
    if (Jn && typeof t == 'function') {
        let i = t.apply(n, a);
        i instanceof Promise
            ? i.then((s) => sa(e, s, n, a)).catch((s) => dn(s, r, t))
            : e(i);
    } else
    ...
    return (
        (oa[e] = t),
        {
            before(n) {
                ...
                const a = rt.indexOf(n);
                rt.splice(a >= 0 ? a : rt.indexOf('DEFAULT'), 0, e);
            },
        }
    );
}
...
function ei(e, t, n) {
    if (((t = Array.from(t)), e._x_virtualDirectives)) {
        let i = Object.entries(e._x_virtualDirectives).map(([o, c]) => ({
                name: o,
                value: c,
            })),
            s = vo(i);
        ((i = i.map((o) =>
            s.find((c) => c.name === o.name)
...
function _u(e, t) {
    ...
    let s = () => {
        e._x_ignore ||
            e._x_ignoreSelf ||
            (a.inline && a.inline(e, t, r),
            (a = a.bind(a, e, t, r)),
            hr ? nn.get(wo).push(a) : a());
    };
...
function Eo(e = () => {}) {
    return ({ name: t, value: n }) => {
        let { name: a, value: r } = Fo.reduce((i, s) => s(i), {
            name: t,
            value: n,
        });
        return (a !== t && e(a, t), { name: a, value: r });
    };
}
var Fo = [];
function ti(e) {
...
function vu(e, t) {
    let n = rt.indexOf(e.type) === -1 ? gr : e.type,
        a = rt.indexOf(t.type) === -1 ? gr : t.type;
    return rt.indexOf(n) - rt.indexOf(a);
}
function rn(e, t, n = {}) {
    e.dispatchEvent(
        new CustomEvent(t, {
...
function dt(e, t) {
    if (typeof ShadowRoot == 'function' && e instanceof ShadowRoot) {
        Array.from(e.children).forEach((r) => dt(r, t));
        return;
    }
    let n = !1;
    if ((t(e, () => (n = !0)), n)) return;
    let a = e.firstElementChild;
    for (; a; ) (dt(a, t), (a = a.nextElementSibling));
}
function pe(e, ...t) {
...
function wu() {
    (Di &&
        ...
        rn(document, 'alpine:init'),
        rn(document, 'alpine:initializing'),
        Xr(),
        tu((t) => Pe(t, dt)),
        Vr((t) => zt(t)),
        co((t, n) => {
    ...
    let e = (t) => !ka(t.parentElement, !0);
    (Array.from(document.querySelectorAll(To().join(',')))
        .filter(e)
        .forEach((t) => {
            Pe(t);
        }),
        rn(document, 'alpine:initialized'),
        setTimeout(() => {
            Eu();
        }));
}
...
function ka(e, t = !1) {
    return qt(e, (n) => {
        if ((t ? To() : Ao()).some((r) => n.matches(r))) return !0;
    });
}
function qt(e, t) {
    if (e) {
        ...
        if ((e._x_teleportBack && (e = e._x_teleportBack), !!e.parentElement))
            return qt(e.parentElement, t);
    }
}
function xu(e) {
    return Ao().some((t) => e.matches(t));
}
var Io = [];
function ku(e) {
    Io.push(e);
        ...
        bu(() => {
            t(e, (a, r) => {
                a._x_marker ||
                    (n(a, r),
                    Io.forEach((i) => i(a, r)),
                    ei(a, a.attributes).forEach((i) => i()),
                    a._x_ignore || (a._x_marker = Cu++),
                    a._x_ignore && r());
            });
        });
}
        ...
        fu(n) ||
            a.some((r) => {
                if (document.querySelector(r))
                    return (pe(`found "${r}", but missing ${t} plugin`), !0);
            });
    });
}
var fr = [],
...
function $u(e, t) {
    ...
    return (
        ...
        () => {
            (s.forEach((o) => e.classList.add(o)),
                i.forEach((o) => e.classList.remove(o)));
        }
    );
}
function Ca(e, t) {
    return typeof t == 'object' && t !== null ? ju(e, t) : Su(e, t);
}
function ju(e, t) {
    let n = {};
    return (
...
W(
    'transition',
    (e, { value: t, modifiers: n, expression: a }, { evaluate: r }) => {
        (typeof a == 'function' && (a = r(a)),
            a !== !1 &&
                (!a || typeof a == 'boolean' ? Ru(e, n, t) : Tu(e, a, t)));
    },
);
function Tu(e, t, n) {
    (No(e, ii, ''),
...
function Ru(e, t, n) {
    No(e, Ca);
    let a = !t.includes('in') && !t.includes('out') && !n,
        r = a || t.includes('in') || ['enter'].includes(n),
        i = a || t.includes('out') || ['leave'].includes(n);
    (t.includes('in') && !a && (t = t.filter((b, _) => _ < t.indexOf('out'))),
        t.includes('out') &&
            !a &&
            (t = t.filter((b, _) => _ > t.indexOf('out'))));
    let s = !t.includes('opacity') && !t.includes('scale'),
        ...
        p = Qt(t, 'delay', 0) / 1e3,
        d = Qt(t, 'origin', 'center'),
        m = 'opacity, transform',
        g = Qt(t, 'duration', 150) / 1e3,
        v = Qt(t, 'duration', 75) / 1e3,
...
function Lo(e) {
    let t = e.parentNode;
    if (t) return t._x_hidePromise ? t : Lo(t);
}
function yr(
    e,
    t,
    { during: n, start: a, end: r } = {},
    i = () => {},
    s = () => {},
) {
    if (
...
function Qt(e, t, n) {
    ...
    if (!a || (t === 'scale' && isNaN(a))) return n;
    if (t === 'duration' || t === 'delay') {
        let r = a.match(/([0-9]+)ms/);
        if (r) return r[1];
    }
    return t === 'origin' &&
...
function Mo(e, t, n, a = []) {
    switch (
        (e._x_bindings || (e._x_bindings = Pt({})),
        (e._x_bindings[t] = n),
        (t = a.includes('camel') ? Hu(t) : t),
        t)
    ) {
        case 'value':
            Du(e, n);
...
function Du(e, t) {
    if (Uo(e))
        (e.attributes.value === void 0 && (e.value = t),
            window.fromModel &&
                (typeof t == 'boolean'
                    ? (e.checked = ea(e.value) === t)
                    : (e.checked = qi(e.value, t))));
    else if (si(e))
        Number.isInteger(t)
            ? (e.value = t)
            : !Array.isArray(t) &&
              ...
              ? (e.value = String(t))
              : Array.isArray(t)
                ? (e.checked = t.some((n) => qi(n, e.value)))
                : (e.checked = !!t);
    else if (e.tagName === 'SELECT') Gu(e, t);
    else {
        if (e.value === t) return;
        e.value = t === void 0 ? '' : t;
    }
...
function Mu(e, t) {
    (e._x_undoAddedClasses && e._x_undoAddedClasses(),
        (e._x_undoAddedClasses = ii(e, t)));
}
function qu(e, t) {
    (e._x_undoAddedStyles && e._x_undoAddedStyles(),
        (e._x_undoAddedStyles = Ca(e, t)));
}
function zu(e, t, n) {
    (qo(e, t, n), Uu(e, t, n));
}
function qo(e, t, n) {
    [null, void 0, !1].includes(n) && Vu(t)
        ? e.removeAttribute(t)
        : (zo(t) && (n = t), Bu(e, t, n));
}
function Bu(e, t, n) {
...
function Yu(e, t, n, a = !0) {
    if (e._x_bindings && e._x_bindings[t] !== void 0) return e._x_bindings[t];
    if (e._x_inlineBindings && e._x_inlineBindings[t] !== void 0) {
        let r = e._x_inlineBindings[t];
        return ((r.extract = a), bo(() => ct(e, r.expression)));
    }
    return Bo(e, t, n);
}
function Bo(e, t, n) {
...
function Ho(e, t) {
    ...
    return function () {
        let a = this,
            r = arguments;
        n || (e.apply(a, r), (n = !0), setTimeout(() => (n = !1), t));
    };
}
function Wo({ get: e, set: t }, { get: n, set: a }) {
    let r = !0,
        i,
        s = gt(() => {
            let o = e(),
...
function Xu(e) {
    (Array.isArray(e) ? e : [e]).forEach((n) => n(xn));
}
var et = {},
    zi = !1;
function Ku(e, t) {
    if ((zi || ((et = Pt(et)), (zi = !0)), t === void 0)) return et[e];
    ((et[e] = t),
        ho(et[e]),
        typeof t == 'object' &&
            t !== null &&
...
function Ju(e, t) {
    ...
    return e instanceof Element ? Zo(e, n()) : ((Vo[e] = n), () => {});
}
function ep(e) {
    return (
        Object.entries(Vo).forEach(([t, n]) => {
...
function Zo(e, t, n) {
    let a = [];
    for (; a.length; ) a.pop()();
    let r = Object.entries(t).map(([s, o]) => ({ name: s, value: o })),
        i = vo(r);
    return (
        (r = r.map((s) =>
...
var ap = {
        ...
        version: '3.14.9',
        flushAndStopDeferringMutations: iu,
        dontAutoEvaluateFunctions: bo,
        disableEffectScheduling: Ql,
        startObservingMutations: Xr,
        stopObservingMutations: po,
        setReactivityEngine: Jl,
        onAttributeRemoved: lo,
        onAttributesAdded: co,
        closestDataStack: At,
        skipDuringClone: Ve,
        onlyDuringClone: Iu,
        addRootSelector: Ro,
...
var ip = Object.freeze({}),
    ...
    Ko = (e) => Xo(e).slice(8, -1),
    ci = (e) =>
        op(e) && e !== 'NaN' && e[0] !== '-' && '' + parseInt(e, 10) === e,
    lp = (e) => {
        const t = Object.create(null);
        return (n) => t[n] || (t[n] = e(n));
    },
    up = lp((e) => e.charAt(0).toUpperCase() + e.slice(1)),
    Qo = (e, t) => e !== t && (e === e || t === t),
    wr = new WeakMap(),
    Jt = [],
    Ee,
...
function mp(e) {
    e.active &&
        (Jo(e), e.options.onStop && e.options.onStop(), (e.active = !1));
}
var hp = 0;
function gp(e, t) {
    const n = function () {
        ...
        if (!Jt.includes(n)) {
            Jo(n);
            try {
                return (bp(), Jt.push(n), (Ee = n), e());
            } finally {
                (Jt.pop(), ec(), (Ee = Jt[Jt.length - 1]));
            }
        }
    };
    return (
...
function ye(e, t, n) {
    if (!Tt || Ee === void 0) return;
    let a = wr.get(e);
    a || wr.set(e, (a = new Map()));
    let r = a.get(n);
    (r || a.set(n, (r = new Set())),
        r.has(Ee) ||
            (r.add(Ee),
...
function We(e, t, n, a, r, i) {
    ...
    const o = new Set(),
        c = (u) => {
            u &&
                u.forEach((p) => {
                    (p !== Ee || p.allowRecurse) && o.add(p);
                });
        };
    if (t === 'clear') s.forEach(c);
    else if (n === 'length' && lt(e))
        s.forEach((u, p) => {
            (p === 'length' || p >= a) && c(u);
        });
    else
        switch ((n !== void 0 && c(s.get(n)), t)) {
            case 'add':
                lt(e)
                    ? ci(n) && c(s.get('length'))
                    : (c(s.get(ut)), sn(e) && c(s.get(xr)));
                break;
            case 'delete':
                lt(e) || (c(s.get(ut)), sn(e) && c(s.get(xr)));
                break;
            case 'set':
                sn(e) && c(s.get(ut));
                break;
...
var _p = rp('__proto__,__v_isRef,__isVue'),
    tc = new Set(
        ...
        ['includes', 'indexOf', 'lastIndexOf'].forEach((t) => {
            e[t] = function (...n) {
                ...
                for (let i = 0, s = this.length; i < s; i++)
                    ye(a, 'get', i + '');
                const r = a[t](...n);
                return r === -1 || r === !1 ? a[t](...n.map(M)) : r;
            };
        }),
        ['push', 'pop', 'shift', 'unshift', 'splice'].forEach((t) => {
            e[t] = function (...n) {
                fp();
                const a = M(this)[t].apply(this, n);
                return (ec(), a);
            };
        }),
        e
...
function nc(e = !1, t = !1) {
    return function (a, r, i) {
        ...
        if (r === '__v_raw' && i === (e ? (t ? Np : sc) : t ? Ip : ic).get(a))
            return a;
        const s = lt(a);
        if (!e && s && Fa(Bi, r)) return Reflect.get(Bi, r, i);
        const o = Reflect.get(a, r, i);
        return (oi(r) ? tc.has(r) : _p(r)) || (e || ye(a, 'get', r), t)
            ? o
            : kr(o)
              ? !s || !ci(r)
                  ? o.value
...
function kp(e = !1) {
    return function (n, a, r, i) {
        let s = n[a];
        if (!e && ((r = M(r)), (s = M(s)), !lt(n) && kr(s) && !kr(r)))
            return ((s.value = r), !0);
        const o = lt(n) && ci(a) ? Number(a) < n.length : Fa(n, a),
            c = Reflect.set(n, a, r, i);
        return (
            n === M(i) &&
                (o ? Qo(r, s) && We(n, 'set', a, r, s) : We(n, 'add', a, r)),
            c
        );
    };
}
...
function Ep(e, t) {
    ...
    return ((!oi(t) || !tc.has(t)) && ye(e, 'has', t), n);
}
function Fp(e) {
    return (ye(e, 'iterate', lt(e) ? 'length' : ut), Reflect.ownKeys(e));
}
var $p = { get: yp, set: xp, deleteProperty: Cp, has: Ep, ownKeys: Fp },
    jp = {
        get: vp,
        set(e, t) {
            return (
...
function qn(e, t, n = !1, a = !1) {
    ...
    const r = M(e),
        i = M(t);
    (t !== i && !n && ye(r, 'get', t), !n && ye(r, 'get', i));
    const { has: s } = ja(r),
        o = a ? di : n ? pi : ui;
    if (s.call(r, t)) return o(e.get(t));
    if (s.call(r, i)) return o(e.get(i));
    e !== r && e.get(t);
}
function zn(e, t = !1) {
...
function Ui(e) {
    e = M(e);
    const t = M(this);
    return (ja(t).has.call(t, e) || (t.add(e), We(t, 'add', e, e)), this);
}
function Gi(e, t) {
    t = M(t);
    const n = M(this),
        { has: a, get: r } = ja(n);
    let i = a.call(n, e);
    i ? rc(n, a, e) : ((e = M(e)), (i = a.call(n, e)));
    const s = r.call(n, e);
    return (
        n.set(e, t),
        i ? Qo(t, s) && We(n, 'set', e, t, s) : We(n, 'add', e, t),
        this
    );
}
function Hi(e) {
...
function Wi() {
    const e = M(this),
        t = e.size !== 0,
        n = sn(e) ? new Map(e) : new Set(e),
        a = e.clear();
    return (t && We(e, 'clear', void 0, void 0, n), a);
}
function Un(e, t) {
    return function (a, r) {
        const i = this,
        ...
        return (
            !e && ye(o, 'iterate', ut),
            s.forEach((l, u) => a.call(r, c(l), c(u), i))
        );
    };
}
function Gn(e, t, n) {
    return function (...a) {
        const r = this.__v_raw,
            ...
            u = n ? di : t ? pi : ui;
        return (
            !t && ye(i, 'iterate', c ? xr : ut),
            {
                next() {
                    const { value: p, done: d } = l.next();
                    return d
                        ? { value: p, done: d }
                        : { value: o ? [u(p[0]), u(p[1])] : u(p), done: d };
                },
                [Symbol.iterator]() {
                    return this;
                },
    ...
    return function (...t) {
        {
            ...
            console.warn(
                `${up(e)} operation ${n}failed: target is readonly.`,
                M(this),
            );
        }
    ...
    return (a, r, i) =>
        r === '__v_isReactive'
            ...
            : r === '__v_isReadonly'
              ...
              : r === '__v_raw'
                ? a
                : Reflect.get(Fa(n, r) && r in a ? n : a, r, i);
}
var Rp = { get: ac(!1) },
    Op = { get: ac(!0) };
function rc(e, t, n) {
...
function Pp(e) {
    return e.__v_skip || !Object.isExtensible(e) ? 0 : Lp(Ko(e));
}
function mi(e) {
    return e && e.__v_isReadonly ? e : cc(e, !1, $p, Rp, ic);
}
function oc(e) {
    return cc(e, !0, jp, Op, sc);
}
...
ve('nextTick', () => ri);
ve('dispatch', (e) => rn.bind(rn, e));
ve('watch', (e, { evaluateLater: t, cleanup: n }) => (a, r) => {
    let i = t(a),
        o = ro(() => {
            let c;
            return (i((l) => (c = l)), c);
...
ve(
    'refs',
    (e) => (e._x_refs_proxy || (e._x_refs_proxy = wn(Dp(e))), e._x_refs_proxy),
);
function Dp(e) {
    let t = [];
    return (
...
ve('el', (e) => e);
uc('Focus', 'focus', 'focus');
uc('Persist', 'persist', 'persist');
function uc(e, t, n) {
    ve(t, (a) =>
        pe(
...
W(
    'modelable',
    (e, { expression: t }, { effect: n, evaluateLater: a, cleanup: r }) => {
        let i = a(t),
            s = () => {
                let u;
                return (i((p) => (u = p)), u);
...
W('teleport', (e, { modifiers: t, expression: n }, { cleanup: a }) => {
...
var pc = () => {};
pc.inline = (e, { modifiers: t }, { cleanup: n }) => {
...
function Cr(e, t, n, a) {
    let r = e,
        ...
        o = (c, l) => (u) => l(c, u);
    if (
        (n.includes('dot') && (t = Up(t)),
        n.includes('camel') && (t = Gp(t)),
        ...
        let c = n[n.indexOf('debounce') + 1] || 'invalid-wait',
            l = ca(c.split('ms')[0]) ? Number(c.split('ms')[0]) : 250;
        i = Go(i, l);
    }
    ...
    return (
        ...
        n.includes('once') &&
            (i = o(i, (c, l) => {
                (c(l), r.removeEventListener(t, i, s));
            })),
...
function Vp(e, t) {
    ...
    if (n.includes('debounce')) {
        ...
        n.splice(i, ca((n[i + 1] || 'invalid-wait').split('ms')[0]) ? 2 : 1);
    }
    if (n.includes('throttle')) {
        let i = n.indexOf('throttle');
        n.splice(i, ca((n[i + 1] || 'invalid-wait').split('ms')[0]) ? 2 : 1);
    }
    if (n.length === 0 || (n.length === 1 && Zi(e.key).includes(n[0])))
        return !1;
    ...
    return (
        ...
        !(
            ...
            (dc(e.type) || Zi(e.key).includes(n[0]))
        )
    );
}
function Zi(e) {
...
W('model', (e, { modifiers: t, expression: n }, { effect: a, cleanup: r }) => {
    let i = e;
    t.includes('parent') && (i = e.parentNode);
    let s = ne(i, n),
        o;
    typeof n == 'string'
        ? (o = ne(i, `${n} = __placeholder`))
        : typeof n == 'function' && typeof n() == 'string'
          ? (o = ne(i, `${n()} = __placeholder`))
          : (o = () => {});
    let c = () => {
            let d;
            return (s((m) => (d = m)), Yi(d) ? d.get() : d);
        },
        l = (d) => {
            let m;
            (s((g) => (m = g)),
    ...
    if (
        ...
        let d = Cr(e.form, 'reset', [], (m) => {
            ri(
                () =>
                    e._x_model && e._x_model.set(Ba(e, t, { target: e }, c())),
            );
        });
        r(() => d());
    }
...
W('cloak', (e) =>
    queueMicrotask(() => z(() => e.removeAttribute(Mt('cloak')))),
);
Oo(() => `[${Mt('init')}]`);
W(
    'init',
...
W('text', (e, { expression: t }, { effect: n, evaluateLater: a }) => {
    let r = a(t);
    n(() => {
        r((i) => {
            z(() => {
...
W('html', (e, { expression: t }, { effect: n, evaluateLater: a }) => {
    let r = a(t);
    n(() => {
        r((i) => {
            z(() => {
...
var mc = (
    e,
    { value: t, modifiers: n, expression: a, original: r },
    { effect: i, cleanup: s },
) => {
    if (!t) {
        let c = {};
    ...
    (i(() =>
        o((c) => {
            (c === void 0 && typeof a == 'string' && a.match(/\./) && (c = ''),
                z(() => Mo(e, t, c, n)));
        }),
    ),
        s(() => {
...
mc.inline = (e, { value: t, modifiers: n, expression: a }) => {
    t &&
        (e._x_inlineBindings || (e._x_inlineBindings = {}),
        (e._x_inlineBindings[t] = { expression: a, extract: !1 }));
};
W('bind', mc);
function Xp(e, t) {
...
Ro(() => `[${Mt('data')}]`);
W('data', (e, { expression: t }, { cleanup: n }) => {
    if (Kp(e)) return;
    t = t === '' ? '{}' : t;
    let a = {};
    mr(a, e);
    let r = {};
    np(r, a);
    let i = ct(e, t, { scope: r });
    ((i === void 0 || i === !0) && (i = {}), mr(i, e));
    let s = Pt(i);
    ho(s);
    let o = vn(e, s);
    (s.init && ct(e, s.init),
        n(() => {
            (s.destroy && ct(e, s.destroy), o());
        }));
});
Ea((e, t) => {
    e._x_dataStack &&
...
function Kp(e) {
    return He ? (vr ? !0 : e.hasAttribute('data-has-alpine-state')) : !1;
}
W('show', (e, { modifiers: t, expression: n }, { effect: a }) => {
    let r = ne(e, n);
    (e._x_doHide ||
        (e._x_doHide = () => {
            z(() => {
        ...
        c = _r(
            ...
            (p) => {
                typeof e._x_toggleAndCascadeWithTransitions == 'function'
                    ? e._x_toggleAndCascadeWithTransitions(e, p, s, i)
                    : p
                      ? o()
                      : i();
            },
...
W('for', (e, { expression: t }, { effect: n, cleanup: a }) => {
    let r = Jp(t),
        i = ne(e, r.items),
        s = ne(e, e._x_keyExpression || 'index');
    ((e._x_prevKeys = []),
        (e._x_lookup = {}),
        n(() => Qp(e, r, i, s)),
        a(() => {
...
function Qp(e, t, n, a) {
    let r = (s) => typeof s == 'object' && !Array.isArray(s),
        i = e;
    n((s) => {
        (ed(s) && s >= 0 && (s = Array.from(Array(s).keys(), (f) => f + 1)),
            s === void 0 && (s = []));
        let o = e._x_lookup,
            c = e._x_prevKeys,
            l = [],
            u = [];
        if (r(s))
            s = Object.entries(s).map(([f, b]) => {
                let _ = Xi(t, b, f, s);
                (a(
                    (w) => {
                        (u.includes(w) && pe('Duplicate key on x-for', e),
                            u.push(w));
                    },
                    { scope: { index: f, ..._ } },
                ),
            ...
            for (let f = 0; f < s.length; f++) {
                ...
                (a(
                    (_) => {
                        (u.includes(_) && pe('Duplicate key on x-for', e),
                            u.push(_));
                    },
                    { scope: { index: f, ...b } },
                ),
        ...
        for (let f = 0; f < u.length; f++) {
            let b = u[f],
                _ = c.indexOf(b);
            if (_ === -1) (c.splice(f, 0, b), p.push([v, f]));
            else if (_ !== f) {
                let w = c.splice(f, 1)[0],
                    h = c.splice(_ - 1, 1)[0];
                (c.splice(f, 0, h), c.splice(_, 0, w), d.push([w, h]));
            } else g.push(b);
            v = b;
        }
        ...
        for (let f = 0; f < d.length; f++) {
            ...
            (z(() => {
                (h || pe('x-for ":key" is undefined or invalid', i, _, o),
                    h.after(C),
                    w.after(h),
                ...
                h._x_refreshXForScope(l[u.indexOf(_)]));
        }
        for (let f = 0; f < p.length; f++) {
            ...
            let h = l[_],
                C = u[_],
                k = document.importNode(i.content, !0).firstElementChild,
                $ = Pt(h);
            (vn(k, $, i),
                (k._x_refreshXForScope = (T) => {
        ...
        for (let f = 0; f < g.length; f++)
            o[g[f]]._x_refreshXForScope(l[u.indexOf(g[f])]);
        i._x_prevKeys = u;
    });
}
function Jp(e) {
...
function hc() {}
hc.inline = (e, { expression: t }, { cleanup: n }) => {
    let a = ka(e);
    (a._x_refs || (a._x_refs = {}),
        (a._x_refs[t] = e),
        n(() => delete a._x_refs[t]));
};
W('ref', hc);
W('if', (e, { expression: t }, { effect: n, cleanup: a }) => {
    e.tagName.toLowerCase() !== 'template' &&
        pe('x-if can only be used on a <template> tag', e);
    let r = ne(e, t),
        i = () => {
...
W(
    'on',
    Ve((e, { value: t, modifiers: n, expression: a }, { cleanup: r }) => {
        let i = a ? ne(e, a) : () => {};
        e.tagName.toLowerCase() === 'template' &&
...
xn.setEvaluator(yo);
xn.setReactivityEngine({ reactive: mi, effect: dp, release: mp, raw: M });
var td = xn,
    gc = td,
    ae = 'top',
    he = 'bottom',
    ...
    en = 'popper',
    ad = 'reference',
    Ki = kn.reduce(function (e, t) {
        return e.concat([t + '-' + Rt, t + '-' + mn]);
    }, []),
    bc = [].concat(kn, [hi]).reduce(function (e, t) {
        ...
        function () {
            Object.keys(t.elements).forEach(function (a) {
                var r = t.elements[a],
                    i = t.attributes[a] || {},
                    s = Object.keys(
                        t.styles.hasOwnProperty(a) ? t.styles[a] : n[a],
                    ),
                    o = s.reduce(function (c, l) {
                        return ((c[l] = ''), c);
                    }, {});
                !me(r) ||
                    !je(r) ||
...
function It(e, t, n) {
    ...
    t &&
        me(e) &&
        ((r = (e.offsetWidth > 0 && Ot(a.width) / e.offsetWidth) || 1),
        (i = (e.offsetHeight > 0 && Ot(a.height) / e.offsetHeight) || 1));
    var s = mt(e) ? oe(e) : window,
        o = s.visualViewport,
        c = !yc() && n,
        l = (a.left + (c && o ? o.offsetLeft : 0)) / r,
        u = (a.top + (c && o ? o.offsetTop : 0)) / i,
        p = a.width / r,
        d = a.height / i;
    return {
        width: p,
...
function Aa(e) {
    return je(e) === 'html'
        ? e
        : e.assignedSlot || e.parentNode || (gi(e) ? e.host : null) || Ze(e);
}
function Qi(e) {
    return !me(e) || De(e).position === 'fixed' ? null : e.offsetParent;
}
function bd(e) {
...
function Cn(e) {
    for (var t = oe(e), n = Qi(e); n && fd(n) && De(n).position === 'static'; )
        n = Qi(n);
    return n &&
        (je(n) === 'html' || (je(n) === 'body' && De(n).position === 'static'))
        ? t
        : n || bd(e) || t;
}
function bi(e) {
...
function wd(e) {
    var t = e.state,
        n = e.options,
        a = n.element,
        r = a === void 0 ? '[data-popper-arrow]' : a;
    r != null &&
        ((typeof r == 'string' &&
            ((r = t.elements.popper.querySelector(r)), !r)) ||
            (vc(t.elements.popper, r) && (t.elements.arrow = r)));
}
const xd = {
    name: 'arrow',
    enabled: !0,
...
var kd = { top: 'auto', right: 'auto', bottom: 'auto', left: 'auto' };
function Cd(e, t) {
    var n = e.x,
        a = e.y,
        r = t.devicePixelRatio || 1;
    return { x: Ot(n * r) / r || 0, y: Ot(a * r) / r || 0 };
}
function Ji(e) {
    var t,
        n = e.popper,
        ...
        g = s.y,
        v = g === void 0 ? 0 : g,
        f = typeof u == 'function' ? u({ x: m, y: v }) : { x: m, y: v };
    ((m = f.x), (v = f.y));
    ...
    if (l) {
        ...
        if (
            ...
            h = he;
            var N =
                p && k === C && C.visualViewport
                    ? C.visualViewport.height
                    : k[$];
            ((v -= N - a.height), (v *= c ? 1 : -1));
        }
        if (r === re || ((r === ae || r === he) && i === mn)) {
            w = ge;
            var I =
                p && k === C && C.visualViewport
    ...
    var D = Object.assign({ position: o }, l && kd),
        R = u === !0 ? Cd({ x: m, y: v }, oe(n)) : { x: m, y: v };
    if (((m = R.x), (v = R.y), c)) {
        var L;
...
function $d(e) {
    var t = e.state,
        ...
        s = a.resize,
        o = s === void 0 ? !0 : s,
        c = oe(t.elements.popper),
        l = [].concat(t.scrollParents.reference, t.scrollParents.popper);
    return (
        i &&
            l.forEach(function (u) {
                u.addEventListener('scroll', n.update, Hn);
            }),
        o && c.addEventListener('resize', n.update, Hn),
        function () {
            (i &&
                l.forEach(function (u) {
                    u.removeEventListener('scroll', n.update, Hn);
                }),
                o && c.removeEventListener('resize', n.update, Hn));
        }
    );
}
const jd = {
...
var Sd = { left: 'right', right: 'left', bottom: 'top', top: 'bottom' };
function ta(e) {
    return e.replace(/left|right|bottom|top/g, function (t) {
        return Sd[t];
    });
}
var Ad = { start: 'end', end: 'start' };
function es(e) {
...
function yi(e) {
    return It(Ze(e)).left + _i(e).scrollLeft;
}
function Td(e, t) {
    var n = oe(e),
        a = Ze(e),
    ...
    return { width: i, height: s, x: o + yi(e), y: c };
}
function Rd(e) {
    var t,
        n = Ze(e),
        ...
        c = -a.scrollTop;
    return (
        De(r || n).direction === 'rtl' &&
            (o += pt(n.clientWidth, r ? r.clientWidth : 0) - i),
        { width: i, height: s, x: o, y: c }
    );
}
function vi(e) {
    var t = De(e),
...
function Cc(e) {
    return ['html', 'body', '#document'].indexOf(je(e)) >= 0
...
function cn(e, t) {
    ...
    var a = Cc(e),
        ...
        i = oe(a),
        s = r ? [i].concat(i.visualViewport || [], vi(a) ? a : []) : a,
        o = t.concat(s);
    return r ? o : o.concat(cn(Aa(s)));
}
function Fr(e) {
...
function ts(e, t, n) {
    return t === fc ? Fr(Td(e, n)) : mt(t) ? Od(t, n) : Fr(Rd(Ze(e)));
}
function Id(e) {
    var t = cn(Aa(e)),
    ...
    return mt(a)
        ? t.filter(function (r) {
              return mt(r) && vc(r, a) && je(r) !== 'body';
          })
        : [];
}
function Nd(e, t, n, a) {
    var r = t === 'clippingParents' ? Id(e) : [].concat(t),
        i = [].concat(r, [n]),
        s = i[0],
        o = i.reduce(
            function (c, l) {
                var u = ts(e, l, a);
                return (
                    (c.top = pt(u.top, c.top)),
                    (c.right = la(u.right, c.right)),
                    (c.bottom = la(u.bottom, c.bottom)),
                    (c.left = pt(u.left, c.left)),
                    c
                );
            },
            ts(e, s, a),
...
function hn(e, t) {
    ...
    var n = t,
        ...
        v = n.padding,
        f = v === void 0 ? 0 : v,
        b = xc(typeof f != 'number' ? f : kc(f, kn)),
        _ = d === en ? ad : en,
        w = e.rects.popper,
        h = e.elements[g ? _ : d],
        C = Nd(mt(h) ? h : h.contextElement || Ze(e.elements.popper), c, u, s),
        k = It(e.elements.reference),
        $ = Ec({ reference: k, element: w, placement: r }),
        T = Fr(Object.assign({}, w, $)),
        N = d === en ? T : k,
        I = {
            top: C.top - N.top + b.top,
            bottom: N.bottom - C.bottom + b.bottom,
            left: C.left - N.left + b.left,
            right: N.right - C.right + b.right,
        },
        D = e.modifiersData.offset;
    if (d === en && D) {
        var R = D[r];
        Object.keys(I).forEach(function (L) {
            var q = [ge, he].indexOf(L) >= 0 ? 1 : -1,
                U = [ae, he].indexOf(L) >= 0 ? 'y' : 'x';
            I[L] += R[U] * q;
        });
    }
    return I;
...
function Ld(e, t) {
    ...
    var n = t,
        ...
        p = u
            ? o
                ? Ki
                : Ki.filter(function (g) {
                      return Nt(g) === u;
                  })
            : kn,
        d = p.filter(function (g) {
            return l.indexOf(g) >= 0;
        });
    d.length === 0 && (d = p);
    var m = d.reduce(function (g, v) {
        return (
            (g[v] = hn(e, {
                placement: v,
                boundary: r,
    ...
    if (!t.modifiersData[a]._skip) {
        for (
            var r = n.mainAxis,
                ...
                _ = b === f,
                w = c || (_ || !g ? [ta(f)] : Pd(f)),
                h = [f].concat(w).reduce(function (Se, fe) {
                    return Se.concat(
                        $e(fe) === hi
                            ? Ld(t, {
                                  placement: fe,
            ...
            if (
                (i && we.push(G[R] <= 0),
                o && we.push(G[Q] <= 0, G[K] <= 0),
                we.every(function (Se) {
                    return Se;
                }))
            ) {
                ((N = D), (T = !1));
        ...
        if (T)
            for (
                var xe = g ? 3 : 1,
                    Ye = function (fe) {
                        var Ae = h.find(function (bt) {
                            var Te = $.get(bt);
                            if (Te)
                                return Te.slice(0, fe).every(function (_t) {
                                    return _t;
                                });
                        });
...
function as(e) {
    return [ae, ge, he, re].some(function (t) {
        return e[t] >= 0;
    });
}
function qd(e) {
    var t = e.state,
        ...
        s = hn(t, { elementContext: 'reference' }),
        o = hn(t, { altBoundary: !0 }),
        c = ns(s, a),
        l = ns(o, r, i),
        u = as(c),
        p = as(l);
...
function Bd(e, t, n) {
    ...
    return (
        (s = s || 0),
        (o = (o || 0) * r),
        [re, ge].indexOf(a) >= 0 ? { x: o, y: s } : { x: s, y: o }
    );
}
function Ud(e) {
    var t = e.state,
        ...
        r = n.offset,
        i = r === void 0 ? [0, 0] : r,
        s = bc.reduce(function (u, p) {
            return ((u[p] = Bd(p, t.rects, i)), u);
        }, {}),
        o = s[t.placement],
        c = o.x,
        l = o.y;
...
function Zd(e) {
    var t = e.state,
        ...
        g = n.tetherOffset,
        v = g === void 0 ? 0 : g,
        f = hn(t, { boundary: c, rootBoundary: l, padding: p, altBoundary: u }),
        b = $e(t.placement),
        _ = Nt(t.placement),
        w = !_,
        h = bi(b),
    ...
    if (k) {
        if (i) {
            var L,
                ...
                ke = _ === Rt ? -T[G] : -$[G],
                Xe = t.elements.arrow,
                Se = m && Xe ? fi(Xe) : { width: 0, height: 0 },
                ...
                Te = on(0, $[G], Se[G]),
                _t = w
                    ? $[G] / 2 - xe - Te - Ae - I.mainAxis
                    : Ye - Te - Ae - I.mainAxis,
                Me = w
                    ? -$[G] / 2 + xe + Te + bt + I.mainAxis
                    : ke + Te + bt + I.mainAxis,
                yt = t.elements.arrow && Cn(t.elements.arrow),
                Sn = yt
                    ? h === 'y'
                        ? yt.clientTop || 0
                        : yt.clientLeft || 0
                ...
                An = Q + _t - Wt - Sn,
                Tn = Q + Me - Wt,
                Vt = on(m ? la(K, An) : K, Q, m ? pt(we, Tn) : we);
            ((k[h] = Vt), (R[h] = Vt - Q));
        }
        if (o) {
            var Zt,
                ...
                Yt = Re + f[Rn],
                Ke = Re - f[On],
                Xt = [ae, re].indexOf(b) !== -1,
                In = (Zt = D?.[C]) != null ? Zt : 0,
                Nn = Xt ? Yt : Re - $[qe] - T[qe] - In + I.altAxis,
                Ln = Xt ? Re + $[qe] + T[qe] - In - I.altAxis : Ke,
                Pn =
                    m && Xt ? _d(Nn, Re, Ln) : on(m ? Nn : Yt, Re, m ? Ln : Ke);
            ((k[C] = Pn), (R[C] = Pn - Re));
        }
        t.modifiersData[a] = R;
    }
...
function Kd(e) {
    return e === oe(e) || !me(e) ? _i(e) : Xd(e);
}
function Qd(e) {
    var t = e.getBoundingClientRect(),
        n = Ot(t.width) / e.offsetWidth || 1,
        a = Ot(t.height) / e.offsetHeight || 1;
    return n !== 1 || a !== 1;
}
function Jd(e, t, n) {
    n === void 0 && (n = !1);
    ...
    return (
        (a || (!a && !n)) &&
            ((je(t) !== 'body' || vi(i)) && (o = Kd(t)),
            me(t)
                ? ((c = It(t, !0)), (c.x += t.clientLeft), (c.y += t.clientTop))
                : i && (c.x = yi(i))),
        {
        ...
        var u = {
            ...
            m = {
                ...
                setOptions: function (b) {
                    ...
                    var w = tm(am([].concat(a, u.options.modifiers)));
                    return (
                        (u.orderedModifiers = w.filter(function (h) {
                            return h.enabled;
                        })),
                        g(),
                        m.update()
                        ...
                        if (is(_, w)) {
                            ((u.rects = {
                                ...
                                u.orderedModifiers.forEach(function (I) {
                                    return (u.modifiersData[I.name] =
                                        Object.assign({}, I.data));
                                }));
                            for (
                                var h = 0;
                                h < u.orderedModifiers.length;
                                h++
                            ) {
                                if (u.reset === !0) {
                                    ((u.reset = !1), (h = -1));
        ...
        function g() {
            u.orderedModifiers.forEach(function (f) {
                ...
                if (typeof h == 'function') {
                    var C = h({ state: u, name: b, instance: m, options: w }),
                        k = function () {};
                    p.push(C || k);
                }
            });
...
var im = [jd, Wd, Fd, _c, Gd, Md, Yd, xd, zd],
    sm = rm({ defaultModifiers: im }),
    om = 'tippy-box',
    Fc = 'tippy-content',
    cm = 'tippy-backdrop',
    $c = 'tippy-arrow',
    jc = 'tippy-svg-arrow',
    tt = { passive: !0, capture: !0 },
    Sc = function () {
...
function gm(e) {
    return Ta(e)
        ...
        : dm(e)
          ...
          : Array.isArray(e)
            ? e
            : ua(document.querySelectorAll(e));
}
function Ha(e, t) {
...
function bm(e, t) {
    ...
    return e.every(function (r) {
        var i = r.popperRect,
            s = r.popperState,
            o = r.props,
            c = o.interactiveBorder,
            l = pm(s.placement),
            u = s.modifiersData.offset;
        if (!u) return !0;
        var p = l === 'bottom' ? u.top.y : 0,
            d = l === 'top' ? u.bottom.y : 0,
            m = l === 'right' ? u.left.x : 0,
            g = l === 'left' ? u.right.x : 0,
            v = i.top - a + p > c,
            f = a - i.bottom - d > c,
            b = i.left - n + m > c,
            _ = n - i.right - g > c;
...
function us(e, t) {
    for (var n = t; n; ) {
        ...
        n =
            n.getRootNode == null || (a = n.getRootNode()) == null
                ? void 0
                : a.host;
    }
    return !1;
...
function _m() {
    Fe.isTouch ||
        ((Fe.isTouch = !0),
        window.performance && document.addEventListener('mousemove', Tc));
}
function Tc() {
    var e = performance.now();
    (e - ps < 20 &&
        ((Fe.isTouch = !1), document.removeEventListener('mousemove', Tc)),
        (ps = e));
}
function ym() {
...
function vm() {
    (document.addEventListener('touchstart', _m, tt),
        window.addEventListener('blur', ym));
}
var wm = typeof window < 'u' && typeof document < 'u',
    xm = wm ? !!window.msCrypto : !1,
    km = {
        animateFill: !1,
        followCursor: !1,
        inlinePositioning: !1,
...
function Rc(e) {
    var t = e.plugins || [],
        n = t.reduce(function (a, r) {
            var i = r.name,
                s = r.defaultValue;
            if (i) {
                var o;
                a[i] = e[i] !== void 0 ? e[i] : (o = _e[i]) != null ? o : s;
            }
            return a;
        }, {});
...
function $m(e, t) {
    var n = t ? Object.keys(Rc(Object.assign({}, _e, { plugins: t }))) : Em,
        a = n.reduce(function (r, i) {
...
function ds(e, t) {
    var n = Object.assign(
        ...
        t.ignoreAttributes ? {} : $m(e, t.plugins),
    );
    return (
        (n.aria = Object.assign({}, _e.aria, n.aria)),
        (n.aria = {
            expanded:
...
function ms(e) {
    ...
    return (
        e === !0
            ? (t.className = $c)
            : ((t.className = jc), Ta(e) ? t.appendChild(e) : $r(t, e)),
        t
    );
}
function hs(e, t) {
    Ta(t.content)
        ? ($r(e, ''), e.appendChild(t.content))
        : typeof t.content != 'function' &&
          (t.allowHTML ? $r(e, t.content) : (e.textContent = t.content));
}
function jr(e) {
    ...
    return {
        ...
        content: n.find(function (a) {
            return a.classList.contains(Fc);
        }),
        arrow: n.find(function (a) {
            return a.classList.contains($c) || a.classList.contains(jc);
        }),
        backdrop: n.find(function (a) {
            return a.classList.contains(cm);
        }),
    };
}
function Oc(e) {
    ...
    function r(i, s) {
        var o = jr(t),
            ...
            u = o.arrow;
        (s.theme
            ? c.setAttribute('data-theme', s.theme)
            : c.removeAttribute('data-theme'),
            typeof s.animation == 'string'
                ? c.setAttribute('data-animation', s.animation)
            ...
            s.role ? c.setAttribute('role', s.role) : c.removeAttribute('role'),
            (i.content !== s.content || i.allowHTML !== s.allowHTML) &&
                hs(l, e.props),
            s.arrow
                ? u
                    ? i.arrow !== s.arrow &&
                      (c.removeChild(u), c.appendChild(ms(s.arrow)))
                    : c.appendChild(ms(s.arrow))
                : u && c.removeChild(u));
    }
    return { popper: t, onUpdate: r };
}
Oc.$$tippy = !0;
var Sm = 1,
    Wn = [],
    Va = [];
function Am(e, t) {
    var n = ds(e, Object.assign({}, _e, Rc(cs(t)))),
        a,
        r,
        i,
        s = !1,
    ...
    function R() {
        var y;
        return !!((y = h.props.render) != null && y.$$tippy);
    }
    function L() {
        return v || e;
    }
    ...
    function G(y) {
        return (h.state.isMounted && !h.state.isVisible) ||
            ...
            (u && u.type === 'focus')
            ? 0
            : Ga(h.props.delay, y ? 0 : 1, _e.delay);
    }
    function Q(y) {
        (y === void 0 && (y = !1),
            (k.style.pointerEvents = h.props.interactive && !y ? '' : 'none'),
            (k.style.zIndex = '' + h.props.zIndex));
    }
    function K(y, E, F) {
        if (
            (F === void 0 && (F = !0),
            ...
            var O;
            (O = h.props)[y].apply(O, E);
        }
    }
    function we() {
        var y = h.props.aria;
        if (y.content) {
            var E = 'aria-' + y.content,
                F = k.id,
                O = Ct(h.props.triggerTarget || e);
            O.forEach(function (A) {
                var te = A.getAttribute(E);
                if (h.state.isVisible) A.setAttribute(E, te ? te + ' ' + F : F);
                else {
                    var ce = te && te.replace(F, '').trim();
                    ce ? A.setAttribute(E, ce) : A.removeAttribute(E);
                }
            });
        }
    }
    function xe() {
        if (!(N || !h.props.aria.expanded)) {
            var y = Ct(h.props.triggerTarget || e);
            y.forEach(function (E) {
                h.props.interactive
                    ? E.setAttribute(
                          'aria-expanded',
                          h.state.isVisible && E === L() ? 'true' : 'false',
                      )
    ...
    function Ye() {
        (q().removeEventListener('mousemove', g),
            (Wn = Wn.filter(function (y) {
                return y !== g;
            })));
    }
    function ke(y) {
        if (!(Fe.isTouch && (c || y.type === 'mousedown'))) {
            var E = (y.composedPath && y.composedPath()[0]) || y.target;
            if (!(h.props.interactive && us(k, E))) {
                if (
                    Ct(h.props.triggerTarget || e).some(function (F) {
                        return us(F, E);
                    })
                ) {
                    if (
    ...
    function fe() {
        var y = q();
        (y.addEventListener('mousedown', ke, !0),
            y.addEventListener('touchend', ke, tt),
            y.addEventListener('touchstart', Se, tt),
            y.addEventListener('touchmove', Xe, tt));
    }
    function Ae() {
        var y = q();
        (y.removeEventListener('mousedown', ke, !0),
            y.removeEventListener('touchend', ke, tt),
            y.removeEventListener('touchstart', Se, tt),
            y.removeEventListener('touchmove', Xe, tt));
    }
    function bt(y, E) {
        _t(y, function () {
            !h.state.isVisible &&
    ...
    function _t(y, E) {
        var F = U().box;
        function O(A) {
            A.target === F && (Wa(F, 'remove', O), E());
        }
        if (y === 0) return E();
        (Wa(F, 'remove', p), Wa(F, 'add', O), (p = O));
    }
    function Me(y, E, F) {
        F === void 0 && (F = !1);
        var O = Ct(h.props.triggerTarget || e);
        O.forEach(function (A) {
            (A.addEventListener(y, E, F),
                m.push({ node: A, eventType: y, handler: E, options: F }));
        });
    }
    function yt() {
        (D() &&
            (Me('touchstart', Wt, { passive: !0 }),
            Me('touchend', Tn, { passive: !0 })),
            lm(h.props.trigger).forEach(function (y) {
                if (y !== 'manual')
                    switch ((Me(y, Wt), y)) {
                        case 'mouseenter':
                            Me('mouseleave', Tn);
    ...
    function Wt(y) {
        var E,
            F = !1;
        if (!(!h.state.isEnabled || Zt(y) || o)) {
            var O = ((E = u) == null ? void 0 : E.type) === 'focus';
            ((u = y),
                (v = y.currentTarget),
                xe(),
                !h.state.isVisible &&
    ...
    function An(y) {
        var E = y.target,
            F = L().contains(E) || k.contains(E);
        if (!(y.type === 'mousemove' && F)) {
            var O = qe()
                .concat(k)
                .map(function (A) {
                    var te,
    ...
    function Tn(y) {
        var E = Zt(y) || (h.props.trigger.indexOf('click') >= 0 && s);
        if (!E) {
            if (h.props.interactive) {
                h.hideWithInteractivity(y);
                return;
            }
            Ke(y);
        }
    ...
    function Vt(y) {
        (h.props.trigger.indexOf('focusin') < 0 && y.target !== L()) ||
            (h.props.interactive &&
                y.relatedTarget &&
                k.contains(y.relatedTarget)) ||
            Ke(y);
    }
    function Zt(y) {
        return Fe.isTouch ? D() !== y.type.indexOf('touch') >= 0 : !1;
    }
    function Rn() {
        On();
        var y = h.props,
            ...
            F = y.placement,
            O = y.offset,
            A = y.getReferenceClientRect,
            te = y.moveTransition,
            ce = R() ? jr(k).arrow : null,
            vt = A
                ? {
                      getBoundingClientRect: A,
                      contextElement: A.contextElement || L(),
                  }
                : e,
            Li = {
                name: '$$tippy',
                        ...
                        (['placement', 'reference-hidden', 'escaped'].forEach(
                            function (Mn) {
                                Mn === 'placement'
                                    ...
                                    : wt.attributes.popper['data-popper-' + Mn]
                                      ? Da.setAttribute('data-' + Mn, '')
                                      : Da.removeAttribute('data-' + Mn);
                            },
                        ),
            ...
            Qe = [
                ...
                { name: 'computeStyles', options: { adaptive: !te } },
                Li,
            ];
        (R() &&
            ce &&
            Qe.push({ name: 'arrow', options: { element: ce, padding: 3 } }),
            Qe.push.apply(Qe, E?.modifiers || []),
            (h.popperInstance = sm(
                vt,
                k,
                Object.assign({}, E, {
    ...
    function Re() {
        var y = h.props.appendTo,
            E,
            F = L();
        ((h.props.interactive && y === Sc) || y === 'parent'
            ? (E = F.parentNode)
            : (E = Ac(y, [F])),
    ...
    function qe() {
        return ua(k.querySelectorAll('[data-tippy-root]'));
    }
    function Yt(y) {
        (h.clearDelayTimeouts(), y && K('onTrigger', [h, y]), fe());
        var E = G(!0),
            F = I(),
            O = F[0],
            A = F[1];
        (Fe.isTouch && O === 'hold' && A && (E = A),
            E
    ...
    function Nn() {
        (clearTimeout(a), clearTimeout(r), cancelAnimationFrame(i));
    }
    function Ln(y) {
        if (!h.state.isDestroyed) {
            (K('onBeforeUpdate', [h, y]), Sn());
            var E = h.props,
                F = ds(
                    e,
                    Object.assign({}, E, cs(y), { ignoreAttributes: !0 }),
                );
            ((h.props = F),
                yt(),
                E.interactiveDebounce !== F.interactiveDebounce &&
                    (Ye(), (g = ss(An, F.interactiveDebounce))),
                E.triggerTarget && !F.triggerTarget
                    ? Ct(E.triggerTarget).forEach(function (O) {
                          O.removeAttribute('aria-expanded');
                      })
                    : F.triggerTarget && e.removeAttribute('aria-expanded'),
                xe(),
                Q(),
                $ && $(E, F),
                h.popperInstance &&
                    ...
                    qe().forEach(function (O) {
                        requestAnimationFrame(
                            O._tippy.popperInstance.forceUpdate,
                        );
                    })),
                K('onAfterUpdate', [h, y]));
        }
    ...
    function Pn(y) {
        h.setProps({ content: y });
    }
    function zl() {
        var y = h.state.isVisible,
            E = h.state.isDestroyed,
            F = !h.state.isEnabled,
            O = Fe.isTouch && !h.props.touch,
            A = Ga(h.props.duration, 0, _e.duration);
        if (
            !(y || E || F || O) &&
            !L().hasAttribute('disabled') &&
            (K('onShow', [h], !1), h.props.onShow(h) !== !1)
        ) {
            if (
                ((h.state.isVisible = !0),
                R() && (k.style.visibility = 'visible'),
                Q(),
                fe(),
                h.state.isMounted || (k.style.transition = 'none'),
                R())
            ) {
                var te = U(),
                    ce = te.box,
            ...
            ((d = function () {
                var Qe;
                if (!(!h.state.isVisible || l)) {
                    if (
                        ((l = !0),
                        k.offsetHeight,
                        (k.style.transition = h.props.moveTransition),
                        R() && h.props.animation)
                    ) {
                        var Pa = U(),
                            Dn = Pa.box,
                            wt = Pa.content;
                        (Ha([Dn, wt], A), ls([Dn, wt], 'visible'));
                    }
                    (we(),
                        xe(),
                        os(Va, h),
                        (Qe = h.popperInstance) == null || Qe.forceUpdate(),
                        K('onMount', [h]),
                        h.props.animation &&
                            R() &&
                            Te(A, function () {
                                ((h.state.isShown = !0), K('onShown', [h]));
                            }));
                }
            }),
                Re());
    ...
    function Bl() {
        var y = !h.state.isVisible,
            E = h.state.isDestroyed,
            F = !h.state.isEnabled,
            O = Ga(h.props.duration, 1, _e.duration);
        if (
            !(y || E || F) &&
            (K('onHide', [h], !1), h.props.onHide(h) !== !1)
        ) {
            if (
                ((h.state.isVisible = !1),
                (h.state.isShown = !1),
                ...
                var A = U(),
                    te = A.box,
                    ce = A.content;
                h.props.animation && (Ha([te, ce], O), ls([te, ce], 'hidden'));
            }
            (we(),
                xe(),
                h.props.animation ? R() && bt(O, h.unmount) : h.unmount());
        }
    }
    function Ul(y) {
        (q().addEventListener('mousemove', g), os(Wn, g), g(y));
    }
    function Gl() {
        (h.state.isVisible && h.hide(),
            h.state.isMounted &&
                (On(),
                qe().forEach(function (y) {
                    y._tippy.unmount();
                }),
                k.parentNode && k.parentNode.removeChild(k),
                (Va = Va.filter(function (y) {
                    return y !== h;
                })),
                (h.state.isMounted = !1),
                K('onHidden', [h])));
...
Object.assign({}, _c, {
    effect: function (t) {
        ...
        (Object.assign(n.elements.popper.style, a.popper),
            (n.styles = a),
            n.elements.arrow && Object.assign(n.elements.arrow.style, a.arrow));
    },
});
En.setDefaultProps({ render: Oc });
...
function Rm(e) {
    let t = [];
    for (let n = 0, a = e.length; n < a; n++) t[n] = xi(e[n]);
    return t;
}
function Om(e) {
    let t = {};
    for (let n in e) t[n] = xi(e[n]);
    return t;
}
function Ic(e, ...t) {
    return (
...
function Nc(e) {
    ...
    return t === 0
        ? e
        : ~t === e.length - 1
          ? Nc(e.substring(0, e.length - 1))
          : e.substr(~t + 1);
}
var Za = /\$(\d+)|\${(\d+):\/(downcase|upcase)}/g,
    Vn = class {
        static hasCaptures(e) {
            return e === null ? !1 : ((Za.lastIndex = 0), Za.test(e));
        }
        static replaceCaptures(e, t, n) {
            return e.replace(Za, (a, r, i, s) => {
                let o = n[parseInt(r || i, 10)];
                if (o) {
                    let c = t.substring(o.start, o.end);
...
var Mc = class {
    ...
    pa = class {
        ...
        static createFromRawTheme(e, t) {
            return this.createFromParsedTheme(Lm(e), t);
        }
        static createFromParsedTheme(e, t) {
            return Dm(e, t);
        }
        _cachedMatchRoot = new Mc((e) => this._root.match(e));
        getColorMap() {
        ...
        match(e) {
            ...
            const t = e.scopeName,
                a = this._cachedMatchRoot
                    .get(t)
                    .find((r) => Im(e.parent, r.parentScopes));
            return a ? new qc(a.fontStyle, a.foreground, a.background) : null;
        }
    },
    Ya = class na {
        constructor(t, n) {
        ...
        static push(t, n) {
            for (const a of n) t = new na(t, a);
            return t;
        }
        static from(...t) {
            let n = null;
            for (let a = 0; a < t.length; a++) n = new na(n, t[a]);
            return n;
        }
        push(t) {
        ...
        getExtensionIfDefined(t) {
            const n = [];
            let a = this;
            for (; a && a !== t; ) (n.push(a.scopeName), (a = a.parent));
            return a === t ? n.reverse() : void 0;
        }
    };
function Im(e, t) {
...
function Lm(e) {
    ...
    for (let r = 0, i = t.length; r < i; r++) {
        ...
        typeof s.settings.foreground == 'string' &&
            gs(s.settings.foreground) &&
            (l = s.settings.foreground);
        let u = null;
        typeof s.settings.background == 'string' &&
            gs(s.settings.background) &&
            (u = s.settings.background);
        for (let p = 0, d = o.length; p < d; p++) {
            let g = o[p].trim().split(' '),
                v = g[g.length - 1],
                f = null;
            (g.length > 1 && ((f = g.slice(0, g.length - 1)), f.reverse()),
                (n[a++] = new Pm(v, f, r, c, l, u)));
        }
    }
    return n;
}
...
function Dm(e, t) {
    e.sort((c, l) => {
        let u = Lc(c.scope, l.scope);
        return u !== 0 || ((u = Pc(c.parentScopes, l.parentScopes)), u !== 0)
            ? u
            : c.index - l.index;
    });
    let n = 0,
    ...
    for (; e.length >= 1 && e[0].scope === ''; ) {
        ...
        (c.fontStyle !== -1 && (n = c.fontStyle),
            c.foreground !== null && (a = c.foreground),
            c.background !== null && (r = c.background));
    }
    let i = new Mm(t),
        s = new qc(n, i.getId(a), i.getId(r)),
        o = new zm(new Sr(0, null, -1, 0, 0), []);
    for (let c = 0, l = e.length; c < l; c++) {
        ...
        o.insert(
            ...
            u.parentScopes,
            u.fontStyle,
            i.getId(u.foreground),
            i.getId(u.background),
        );
    }
    return new pa(i, s, o);
}
var Mm = class {
    ...
    Sr = class zc {
        ...
        static cloneArr(t) {
            let n = [];
            for (let a = 0, r = t.length; a < r; a++) n[a] = t[a].clone();
            return n;
        }
        acceptOverwrite(t, n, a, r) {
            (this.scopeDepth > t
    ...
    zm = class Ar {
        ...
        static _cmpBySpecificity(t, n) {
            ...
            for (
                ...
                t.parentScopes[a] === '>' && a++,
                    n.parentScopes[r] === '>' && r++,
                    !(a >= t.parentScopes.length || r >= n.parentScopes.length);
            ) {
                const i = n.parentScopes[r].length - t.parentScopes[a].length;
                if (i !== 0) return i;
                (a++, r++);
            }
        ...
        insert(t, n, a, r, i, s) {
            ...
            o === -1
                ? ((c = n), (l = ''))
                : ((c = n.substring(0, o)), (l = n.substring(o + 1)));
            let u;
            (this._children.hasOwnProperty(c)
                ? (u = this._children[c])
                : ((u = new Ar(
                      this._mainRule.clone(),
                      Sr.cloneArr(this._rulesWithParentScopes),
                  )),
                  (this._children[c] = u)),
                u.insert(t + 1, l, a, r, i, s));
        }
        _doInsertHere(t, n, a, r, i) {
            if (n === null) {
                this._mainRule.acceptOverwrite(t, a, r, i);
                return;
            }
            for (
                ...
                if (Pc(c.parentScopes, n) === 0) {
                    c.acceptOverwrite(t, a, r, i);
                    return;
                }
            }
            (a === -1 && (a = this._mainRule.fontStyle),
                ...
                this._rulesWithParentScopes.push(new Sr(t, n, a, r, i)));
        }
    },
    Lt = class le {
        ...
        static print(t) {
            const n = le.getLanguageId(t),
                a = le.getTokenType(t),
                r = le.getFontStyle(t),
                i = le.getForeground(t),
                s = le.getBackground(t);
            console.log({
                languageId: n,
                tokenType: a,
                fontStyle: r,
        ...
        static set(t, n, a, r, i, s, o) {
            let c = le.getLanguageId(t),
                l = le.getTokenType(t),
                u = le.containsBalancedBrackets(t) ? 1 : 0,
                p = le.getFontStyle(t),
                d = le.getForeground(t),
                m = le.getBackground(t);
            return (
                n !== 0 && (c = n),
                a !== 8 && (l = a),
                r !== null && (u = r ? 1 : 0),
...
function da(e, t) {
    ...
    for (; r !== null; ) {
        ...
        let l = s();
        if ((n.push({ matcher: l, priority: c }), r !== ',')) break;
        r = a.next();
    }
    return n;
    function i() {
    ...
    Hm = class {
        constructor(e, t) {
            ((this.repo = e),
                ...
                (this.Q = [new gn(this.initialScopeName)]));
        }
        ...
        processQueue() {
            ...
            this.Q = [];
            const t = new Gm();
            for (const n of e) Wm(n, this.initialScopeName, this.repo, t);
...
function Wm(e, t, n, a) {
    ...
    const i = n.lookup(t);
    e instanceof gn
        ? aa({ baseGrammar: i, selfGrammar: r }, a)
        : Tr(
              e.ruleName,
    ...
    if (s) for (const o of s) a.add(new gn(o));
}
function Tr(e, t, n) {
    if (t.repository && t.repository[e]) {
        const a = t.repository[e];
        ma([a], t, n);
    }
}
function aa(e, t) {
...
function ma(e, t, n) {
    for (const a of e) {
        ...
        const r = a.repository
            ? Ic({}, t.repository, a.repository)
            : t.repository;
        Array.isArray(a.patterns) && ma(a.patterns, { ...t, repository: r }, n);
        const i = a.include;
        if (!i) continue;
        const s = Uc(i);
        switch (s.kind) {
            case 0:
                aa({ ...t, selfGrammar: t.baseGrammar }, n);
                break;
            case 1:
                aa(t, n);
                break;
            case 2:
                Tr(s.ruleName, { ...t, repository: r }, n);
                break;
            case 3:
            case 4:
                const o =
                ...
                if (o) {
                    ...
                    s.kind === 4 ? Tr(s.ruleName, c, n) : aa(c, n);
                } else
                    s.kind === 4
                        ? n.add(new Um(s.scopeName, s.ruleName))
                        : n.add(new gn(s.scopeName));
                break;
        }
    }
}
...
function Uc(e) {
    if (e === '$base') return new Vm();
    if (e === '$self') return new Zm();
    const t = e.indexOf('#');
    if (t === -1) return new Xm(e);
    if (t === 0) return new Ym(e.substring(1));
    {
...
var Fn = class {
        ...
        constructor(e, t, n, a) {
            ((this.$location = e),
                (this.id = t),
                (this._name = n || null),
                (this._nameIsCapturing = Vn.hasCaptures(this._name)),
                (this._contentName = a || null),
                (this._contentNameIsCapturing = Vn.hasCaptures(
                    this._contentName,
                )));
        }
        get debugName() {
            const e = this.$location
                ? `${Nc(this.$location.filename)}:${this.$location.line}`
                : 'unknown';
        ...
        getName(e, t) {
            return !this._nameIsCapturing ||
                ...
                t === null
                ? this._name
                : Vn.replaceCaptures(this._name, e, t);
        }
        getContentName(e, t) {
            return !this._contentNameIsCapturing || this._contentName === null
                ? this._contentName
                : Vn.replaceCaptures(this._contentName, e, t);
        }
    },
    eh = class extends Fn {
        retokenizeCapturedWithRuleId;
        constructor(e, t, n, a, r) {
            (super(e, t, n, a), (this.retokenizeCapturedWithRuleId = r));
        }
        dispose() {}
        collectPatterns(e, t) {
    ...
    th = class extends Fn {
        ...
        compileAG(e, t, n, a) {
            return this._getCachedCompiledPatterns(e).compileAG(e, n, a);
        }
        _getCachedCompiledPatterns(e) {
            return (
                this._cachedCompiledPatterns ||
                    ((this._cachedCompiledPatterns = new bn()),
    ...
    Rr = class extends Fn {
        ...
        patterns;
        _cachedCompiledPatterns;
        constructor(e, t, n, a, r, i, s, o, c, l) {
            (super(e, t, n, a),
                (this._begin = new fn(r, this.id)),
                (this.beginCaptures = i),
                (this._end = new fn(s || '￿', -1)),
        ...
        compileAG(e, t, n, a) {
            return this._getCachedCompiledPatterns(e, t).compileAG(e, n, a);
        }
        _getCachedCompiledPatterns(e, t) {
            if (!this._cachedCompiledPatterns) {
                this._cachedCompiledPatterns = new bn();
                for (const n of this.patterns)
                    e.getRule(n).collectPatterns(
                        e,
                        this._cachedCompiledPatterns,
                    );
    ...
    ha = class extends Fn {
        ...
        constructor(e, t, n, a, r, i, s, o, c) {
            (super(e, t, n, a),
                (this._begin = new fn(r, this.id)),
                (this.beginCaptures = i),
                (this.whileCaptures = o),
                (this._while = new fn(s, Gc)),
        ...
        _getCachedCompiledWhilePatterns(e, t) {
            return (
                this._cachedCompiledWhilePatterns ||
                    ((this._cachedCompiledWhilePatterns = new bn()),
    ...
    Hc = class J {
        static createCaptureRule(t, n, a, r, i) {
            return t.registerRule((s) => new eh(n, s, a, r, i));
        }
        static getCompiledRuleId(t, n, a) {
            return (
                t.id ||
                    n.registerRule((r) => {
                        if (((t.id = r), t.match))
                            return new th(
                                ...
                                t.name,
                                t.match,
                                J._compileCaptures(t.captures, n, a),
                            );
                        if (typeof t.begin > 'u') {
                            t.repository && (a = Ic({}, a, t.repository));
                            let i = t.patterns;
                            return (
                                typeof i > 'u' &&
                                    t.include &&
                        ...
                        return t.while
                            ? new ha(
                                  ...
                                  J._compilePatterns(t.patterns, n, a),
                              )
                            : new Rr(
                                  t.$vscodeTextmateLocation,
                                  t.id,
        ...
        static _compileCaptures(t, n, a) {
            ...
            if (t) {
                ...
                for (let s = 0; s <= i; s++) r[s] = null;
                for (const s in t) {
                    if (s === '$vscodeTextmateLocation') continue;
                    const o = parseInt(s, 10);
                    let c = 0;
                    (t[s].patterns && (c = J.getCompiledRuleId(t[s], n, a)),
                        (r[o] = J.createCaptureRule(
                            n,
        ...
        static _compilePatterns(t, n, a) {
            ...
            if (t)
                for (let i = 0, s = t.length; i < s; i++) {
                    ...
                    let c = -1;
                    if (o.include) {
                        const l = Uc(o.include);
                        switch (l.kind) {
                            case 0:
                            case 1:
                                c = J.getCompiledRuleId(a[o.include], n, a);
                                break;
                            case 2:
                                let u = a[l.ruleName];
                                u && (c = J.getCompiledRuleId(u, n, a));
                                break;
                            case 3:
                            case 4:
                                const p = l.scopeName,
                                    d = l.kind === 4 ? l.ruleName : null,
                                    m = n.getExternalGrammar(p, a);
                                if (m)
                                    if (d) {
                                        let g = m.repository[d];
                                        g &&
                                            (c = J.getCompiledRuleId(
                                                g,
                                                n,
                                                m.repository,
                                            ));
                    ...
                    } else c = J.getCompiledRuleId(o, n, a);
                    if (c !== -1) {
                        const l = n.getRule(c);
                        let u = !1;
                        if (
    ...
    fn = class Wc {
        ...
        constructor(t, n) {
            ...
            (this.hasAnchor
                ...
                typeof this.source == 'string'
                    ? (this.hasBackReferences = Qm.test(this.source))
                    : (this.hasBackReferences = !1));
        }
        clone() {
            return new Wc(this.source, this.ruleId);
        }
        setSource(t) {
            this.source !== t &&
                ((this.source = t),
        ...
        resolveBackReferences(t, n) {
            ...
            let a = n.map((r) => t.substring(r.start, r.end));
            return (
                (bs.lastIndex = 0),
                this.source.replace(bs, (r, i) => Dc(a[parseInt(i, 10)] || ''))
            );
        }
        _buildAnchorCache() {
            if (typeof this.source != 'string')
    ...
    bn = class {
        ...
        _resolveAnchors(e, t, n) {
            let a = this._items.map((r) => r.resolveAnchors(t, n));
            return new ys(
                e,
                a,
...
`);
        ...
        findNextMatchSync(e, t, n) {
            const a = this.scanner.findNextMatchSync(e, t, n);
            return a
                ? {
    ...
    nh = class Or {
        ...
        constructor(t, n) {
            ((this._defaultAttributes = new Xa(t, 8)),
                (this._embeddedLanguagesMatcher = new ah(
                    Object.entries(n || {}),
                )));
        }
        ...
        getBasicScopeAttributes(t) {
            return t === null
                ? Or._NULL_SCOPE_METADATA
                : this._getBasicScopeAttributes.get(t);
        }
        static _NULL_SCOPE_METADATA = new Xa(0, 0);
        _getBasicScopeAttributes = new Mc((t) => {
        ...
        _toStandardTokenType(t) {
            const n = t.match(Or.STANDARD_TOKEN_TYPE_REGEXP);
            if (!n) return 8;
            switch (n[1]) {
                case 'comment':
                    return 1;
...
function Vc(e, t, n, a, r, i, s, o) {
    const c = t.content.length;
    let l = !1,
        u = -1;
    if (s) {
        const m = rh(e, t, n, a, r, i);
        ((r = m.stack),
            (a = m.linePos),
            (n = m.isFirstLine),
            (u = m.anchorPosition));
    ...
    const p = Date.now();
    for (; !l; ) {
        if (o !== 0 && Date.now() - p > o) return new vs(r, !0);
        d();
    }
    return new vs(r, !1);
    function d() {
        const m = ih(e, t, n, a, r, u);
        if (!m) {
            (i.produce(r, c), (l = !0));
            return;
        }
        const g = m.captureIndices,
            v = m.matchedRuleId,
            f = g && g.length > 0 ? g[0].end > a : !1;
        if (v === Jm) {
            const b = r.getRule(e);
            (i.produce(r, g[0].start),
                (r = r.withContentNameScopesList(r.nameScopesList)),
                an(e, t, n, r, i, b.endCaptures, g),
                i.produce(r, g[0].end));
            const _ = r;
            if (
                ((r = r.parent),
            ...
            i.produce(r, g[0].start);
            const _ = r,
                w = b.getName(t.content, g),
                h = r.contentNameScopesList.pushAttributed(w, e);
            if (
                ((r = r.push(v, a, u, g[0].end === c, null, h, h)),
                b instanceof Rr)
            ) {
                const C = b;
                (an(e, t, n, r, i, C.beginCaptures, g),
                    i.produce(r, g[0].end),
                    (u = g[0].end));
                const k = C.getContentName(t.content, g),
                    $ = h.pushAttributed(k, e);
                if (
                    ((r = r.withContentNameScopesList($)),
                    C.endHasBackReferences &&
                        (r = r.withEndRule(
                            C.getEndWithResolvedBackReferences(t.content, g),
                        )),
                    !f && _.hasSameRuleAs(r))
                ) {
                    ((r = r.pop()), i.produce(r, c), (l = !0));
                    return;
                }
            } else if (b instanceof ha) {
                const C = b;
                (an(e, t, n, r, i, C.beginCaptures, g),
                    i.produce(r, g[0].end),
                    (u = g[0].end));
                ...
                if (
                    ...
                    C.whileHasBackReferences &&
                        (r = r.withEndRule(
                            C.getWhileWithResolvedBackReferences(t.content, g),
                        )),
                    !f && _.hasSameRuleAs(r))
                ) {
                    ((r = r.pop()), i.produce(r, c), (l = !0));
                ...
                (an(e, t, n, r, i, b.captures, g),
                i.produce(r, g[0].end),
                (r = r.pop()),
                !f)
            ) {
                ((r = r.safePop()), i.produce(r, c), (l = !0));
                return;
            }
        }
        g[0].end > a && ((a = g[0].end), (n = !1));
    }
}
function rh(e, t, n, a, r, i) {
    let s = r.beginRuleCapturedEOL ? 0 : -1;
    const o = [];
    for (let c = r; c; c = c.pop()) {
        const l = c.getRule(e);
        l instanceof ha && o.push({ rule: l, stack: c });
    }
    for (let c = o.pop(); c; c = o.pop()) {
        const { ruleScanner: l, findOptions: u } = ch(
                c.rule,
                e,
                c.stack.endRule,
                n,
        ...
        if (p) {
            ...
            p.captureIndices &&
                ...
                (i.produce(c.stack, p.captureIndices[0].start),
                an(e, t, n, c.stack, i, c.rule.whileCaptures, p.captureIndices),
                i.produce(c.stack, p.captureIndices[0].end),
                (s = p.captureIndices[0].end),
                p.captureIndices[0].end > a &&
                    ((a = p.captureIndices[0].end), (n = !1)));
        } else {
            r = c.stack.pop();
            break;
        }
    }
    return { stack: r, linePos: a, anchorPosition: s, isFirstLine: n };
}
function ih(e, t, n, a, r, i) {
    const s = sh(e, t, n, a, r, i),
        o = e.getInjections();
    if (o.length === 0) return s;
    const c = oh(o, e, t, n, a, r, i);
    if (!c) return s;
    if (!s) return c;
    const l = s.captureIndices[0].start,
        u = c.captureIndices[0].start;
    return u < l || (c.priorityMatch && u === l) ? c : s;
}
function sh(e, t, n, a, r, i) {
    const s = r.getRule(e),
        { ruleScanner: o, findOptions: c } = Zc(s, e, r.endRule, n, a === i),
        l = o.findNextMatchSync(t, a, c);
    return l
        ? { captureIndices: l.captureIndices, matchedRuleId: l.ruleId }
        : null;
}
function oh(e, t, n, a, r, i, s) {
    ...
    for (let d = 0, m = e.length; d < m; d++) {
        const g = e[d];
        if (!g.matcher(p)) continue;
        const v = t.getRule(g.ruleId),
            { ruleScanner: f, findOptions: b } = Zc(v, t, null, a, r === s),
            _ = f.findNextMatchSync(n, r, b);
        if (!_) continue;
...
function Zc(e, t, n, a, r) {
    return { ruleScanner: e.compileAG(t, n, a, r), findOptions: 0 };
}
function ch(e, t, n, a, r) {
    return { ruleScanner: e.compileWhileAG(t, n, a, r), findOptions: 0 };
}
function an(e, t, n, a, r, i, s) {
    ...
    for (let p = 0; p < c; p++) {
        ...
        if (m.start > u) break;
        for (; l.length > 0 && l[l.length - 1].endPos <= m.start; )
            (r.produceFromScopes(
                l[l.length - 1].scopes,
                l[l.length - 1].endPos,
            ),
        ...
        if (
            (l.length > 0
                ? r.produceFromScopes(l[l.length - 1].scopes, m.start)
                : r.produce(a, m.start),
            d.retokenizeCapturedWithRuleId)
        ) {
            const v = d.getName(o, s),
                f = a.contentNameScopesList.pushAttributed(v, e),
                b = d.getContentName(o, s),
                _ = f.pushAttributed(b, e),
                w = a.push(
                    d.retokenizeCapturedWithRuleId,
                    m.start,
                    -1,
                ...
                h = e.createOnigString(o.substring(0, m.end));
            (Vc(e, h, n && m.start === 0, m.start, w, r, !1, 0), Bc(h));
            continue;
        }
        const g = d.getName(o, s);
        if (g !== null) {
            const f = (
                l.length > 0 ? l[l.length - 1].scopes : a.contentNameScopesList
            ).pushAttributed(g, e);
            l.push(new lh(f, m.end));
        }
    }
    for (; l.length > 0; )
        (r.produceFromScopes(l[l.length - 1].scopes, l[l.length - 1].endPos),
            l.pop());
}
var lh = class {
    scopes;
...
function uh(e, t, n, a, r, i, s, o) {
    return new dh(e, t, n, a, r, i, s, o);
}
function ws(e, t, n, a, r) {
    const i = da(t, ga),
        s = Hc.getCompiledRuleId(n, a, r.repository);
    for (const o of i)
        e.push({
            debugSelector: t,
            matcher: o.matcher,
...
var dh = class {
    constructor(e, t, n, a, r, i, s, o) {
        if (
            ((this._rootScopeName = e),
            (this.balancedBracketSelectors = i),
            (this._onigLib = o),
            (this._basicScopeAttributesProvider = new nh(n, a)),
            (this._rootId = -1),
            (this._lastRuleId = 0),
            (this._ruleId2desc = [null]),
            (this._includedGrammars = {}),
            (this._grammarRepository = s),
            (this._grammar = xs(t, null)),
    ...
    getExternalGrammar(e, t) {
        ...
        if (this._grammarRepository) {
            ...
            if (n)
                return (
                    (this._includedGrammars[e] = xs(n, t && t.$base)),
                    this._includedGrammars[e]
                );
        }
    }
    tokenizeLine(e, t, n = 0) {
        const a = this._tokenize(e, t, !1, n);
        return {
    ...
    tokenizeLine2(e, t, n = 0) {
        const a = this._tokenize(e, t, !0, n);
        return {
    ...
    _tokenize(e, t, n, a) {
        this._rootId === -1 &&
            ((this._rootId = Hc.getCompiledRuleId(
        ...
        if (!t || t === Ir.NULL) {
            ...
            const l = this._basicScopeAttributesProvider.getDefaultAttributes(),
                ...
                d = this.getRule(this._rootId).getName(null, null);
            let m;
            (d
                ? (m = un.createRootAndLookUpScopeName(d, p, this))
                : (m = un.createRoot('unknown', p)),
                (t = new Ir(null, this._rootId, -1, -1, !1, null, m, m)));
        } else ((r = !1), t.reset());
        e =
            e +
            `
...
var un = class Ce {
        constructor(t, n, a) {
            ((this.parent = t),
                (this.scopePath = n),
                (this.tokenAttributes = a));
        }
        static fromExtension(t, n) {
            let a = t,
                r = t?.scopePath ?? null;
            for (const i of n)
                ((r = Ya.push(r, i.scopeNames)),
                    (a = new Ce(a, r, i.encodedTokenAttributes)));
            return a;
        }
        static createRoot(t, n) {
            return new Ce(null, new Ya(null, t), n);
        }
        static createRootAndLookUpScopeName(t, n, a) {
            const r = a.getMetadataForScope(t),
                i = new Ya(null, t),
                s = a.themeProvider.themeMatch(i),
                o = Ce.mergeAttributes(n, r, s);
            return new Ce(null, i, o);
        }
        get scopeName() {
        ...
        static equals(t, n) {
            do {
                ...
                if (
                    !t ||
                    !n ||
                    t.scopeName !== n.scopeName ||
                    t.tokenAttributes !== n.tokenAttributes
                )
                    return !1;
                ((t = t.parent), (n = n.parent));
            } while (!0);
        }
        static mergeAttributes(t, n, a) {
            let r = -1,
                i = 0,
                s = 0;
            return (
                a !== null &&
                    ...
                    (i = a.foregroundId),
                    (s = a.backgroundId)),
                Lt.set(t, n.languageId, n.tokenType, null, r, i, s)
            );
        }
        pushAttributed(t, n) {
            if (t === null) return this;
            if (t.indexOf(' ') === -1) return Ce._pushAttributed(this, t, n);
            const a = t.split(/ /g);
            let r = this;
            for (const i of a) r = Ce._pushAttributed(r, i, n);
            return r;
        }
        static _pushAttributed(t, n, a) {
            const r = a.getMetadataForScope(n),
                i = t.scopePath.push(n),
                s = a.themeProvider.themeMatch(i),
                o = Ce.mergeAttributes(t.tokenAttributes, r, s);
            return new Ce(t, i, o);
        }
        getScopeNames() {
    ...
    Ir = class nt {
        ...
        static NULL = new nt(null, 0, 0, 0, !1, null, null, null);
        _enterPos;
        _anchorPos;
        depth;
        equals(t) {
            return t === null ? !1 : nt._equals(this, t);
        }
        static _equals(t, n) {
            return t === n
                ? !0
                : this._structuralEquals(t, n)
                  ? un.equals(t.contentNameScopesList, n.contentNameScopesList)
                  : !1;
        }
        ...
        push(t, n, a, r, i, s, o) {
            return new nt(this, t, n, a, r, i, s, o);
        }
        getEnterPos() {
        ...
        static pushFrame(t, n) {
            ...
            return new nt(
                ...
                n.endRule,
                a,
                un.fromExtension(a, n.contentNameScopesList),
            );
        }
    },
    mh = class {
        ...
        produceFromScopes(e, t) {
            ...
            if (this._emitBinaryTokens) {
                ...
                if (
                    ...
                    const i = e?.getScopeNames() ?? [];
                    for (const s of this._tokenTypeOverrides)
                        s.matcher(i) &&
                            (a = Lt.set(a, 0, s.type, null, -1, 0, 0));
                    this.balancedBracketSelectors &&
                        (r = this.balancedBracketSelectors.match(i));
                }
                if (
                    (r && (a = Lt.set(a, 0, 8, r, -1, 0, 0)),
                    this._binaryTokens.length > 0 &&
                        this._binaryTokens[this._binaryTokens.length - 1] === a)
                ) {
                    this._lastTokenEndIndex = t;
                    return;
                }
                (this._binaryTokens.push(this._lastTokenEndIndex),
                    this._binaryTokens.push(a),
                    (this._lastTokenEndIndex = t));
                return;
            }
    ...
    gh = class {
        ...
        grammarForScopeName(e, t, n, a, r) {
            if (!this._grammars.has(e)) {
                let i = this._rawGrammars.get(e);
                if (!i) return null;
                this._grammars.set(
                    e,
                    uh(e, i, t, n, a, r, this, this._onigLib),
                );
            }
    ...
    fh = class {
        ...
        constructor(t) {
            ((this._options = t),
                (this._syncRegistry = new gh(
                    pa.createFromRawTheme(t.theme, t.colorMap),
                    t.onigLib,
                )),
        ...
        setTheme(t, n) {
            this._syncRegistry.setTheme(pa.createFromRawTheme(t, n));
        }
        getColorMap() {
            return this._syncRegistry.getColorMap();
        }
        loadGrammarWithEmbeddedLanguages(t, n, a) {
            return this.loadGrammarWithConfiguration(t, n, {
                embeddedLanguages: a,
            });
        }
        loadGrammarWithConfiguration(t, n, a) {
        ...
        _loadGrammar(t, n, a, r, i) {
            const s = new Hm(this._syncRegistry, t);
            for (; s.Q.length > 0; )
                (s.Q.map((o) => this._loadSingleGrammar(o.scopeName)),
                    s.processQueue());
            return this._grammarForScopeName(t, n, a, r, i);
        }
        _loadSingleGrammar(t) {
            this._ensureGrammarCache.has(t) ||
                (this._doLoadSingleGrammar(t),
                this._ensureGrammarCache.set(t, !0));
        }
            ...
            if (n) {
                const a =
                    typeof this._options.getInjections == 'function'
                        ...
                        : void 0;
                this._syncRegistry.addGrammar(n, a);
            }
        }
        addGrammar(t, n = [], a = 0, r = null) {
            return (
                this._syncRegistry.addGrammar(t, n),
                this._grammarForScopeName(t.scopeName, a, r)
            );
        }
        _grammarForScopeName(t, n = 0, a = null, r = null, i = null) {
            return this._syncRegistry.grammarForScopeName(t, n, a, r, i);
        }
    },
    Nr = Ir.NULL;
const bh = [
...
class $n {
    constructor(t, n, a) {
        ((this.normal = n), (this.property = t), a && (this.space = a));
    }
}
$n.prototype.normal = {};
...
function Yc(e, t) {
    const n = {},
        a = {};
    for (const r of e)
        (Object.assign(n, r.property), Object.assign(a, r.normal));
    return new $n(n, a, t);
}
function Lr(e) {
...
class ki extends ie {
    constructor(t, n, a, r) {
        let i = -1;
        if ((super(t, n), ks(this, 'space', r), typeof a == 'number'))
            for (; ++i < Ka.length; ) {
                const s = Ka[i];
                ks(this, Ka[i], (a & Dr[s]) === Dr[s]);
            }
    }
}
...
function Bt(e) {
    ...
    for (const [a, r] of Object.entries(e.properties)) {
        const i = new ki(a, e.transform(e.attributes || {}, a), r, e.space);
        (e.mustUseProperty &&
...
function kh(e, t) {
    ...
    if (n.length > 4 && n.slice(0, 4) === 'data' && xh.test(t)) {
        if (t.charAt(4) === '-') {
            const i = t.slice(5).replace(Cs, Eh);
            a = 'data' + i.charAt(0).toUpperCase() + i.slice(1);
        } else {
            const i = t.slice(4);
            if (!Cs.test(i)) {
                let s = i.replace(wh, Ch);
...
const Fh = Yc([Xc, yh, Jc, el, tl], 'html'),
    nl = Yc([Xc, vh, Jc, el, tl], 'svg'),
    Es = {}.hasOwnProperty;
function $h(e, t) {
    const n = t || {};
    function a(r, ...i) {
        ...
        if (r && Es.call(r, e)) {
            const c = String(r[e]);
            s = Es.call(o, c) ? o[c] : a.unknown;
        }
        if (s) return s.call(this, r, ...i);
    }
    return (
...
const jh = /["&'<>`]/g,
    Sh = /[\uD800-\uDBFF][\uDC00-\uDFFF]/g,
    Ah = /[\x01-\t\v\f\x0E-\x1F\x7F\x81\x8D\x8F\x90\x9D\xA0-\uFFFF]/g,
    Th = /[|\\{}()[\]^$+*?.]/g,
    Fs = new WeakMap();
function Rh(e, t) {
    if (
        ((e = e.replace(t.subset ? Oh(t.subset) : jh, a)),
        t.subset || t.escapeOnly)
    )
        return e;
    return e.replace(Sh, n).replace(Ah, a);
    function n(r, i, s) {
        return t.format(
    ...
    function a(r, i, s) {
        return t.format(r.charCodeAt(0), s.charCodeAt(i + 1), t);
    }
}
function Oh(e) {
    let t = Fs.get(e);
    return (t || ((t = Ih(e)), Fs.set(e, t)), t);
}
function Ih(e) {
    const t = [];
    let n = -1;
    for (; ++n < e.length; ) t.push(e[n].replace(Th, '\\$&'));
    return new RegExp('(?:' + t.join('|') + ')', 'g');
}
const Nh = /[\dA-Fa-f]/;
function Lh(e, t, n) {
    const a = '&#x' + e.toString(16).toUpperCase();
    return n && t && !Nh.test(String.fromCharCode(t)) ? a : a + ';';
}
const Ph = /\d/;
function Dh(e, t, n) {
    const a = '&#' + String(e);
    return n && t && !Ph.test(String.fromCharCode(t)) ? a : a + ';';
}
const Mh = [
        'AElig',
        'AMP',
    ...
    qh = ['cent', 'copy', 'divide', 'gt', 'lt', 'not', 'para', 'times'],
    al = {}.hasOwnProperty,
    Mr = {};
let Zn;
for (Zn in Qa) al.call(Qa, Zn) && (Mr[Qa[Zn]] = Zn);
const zh = /[^\dA-Za-z]/;
function Bh(e, t, n, a) {
    ...
    if (al.call(Mr, r)) {
        ...
        return n &&
            Mh.includes(i) &&
            !qh.includes(i) &&
            (!a || (t && t !== 61 && zh.test(String.fromCharCode(t))))
            ? s
            : s + ';';
    }
    return '';
...
function Vh(e, t, n, a) {
    return a.settings.bogusComments
        ? '<?' +
              ...
              '>'
        : '<!--' + e.value.replace(Gh, r) + '-->';
    function r(i) {
        return St(
            i,
            Object.assign({}, a.settings.characterReferences, { subset: Wh }),
        );
    }
}
function Zh(e, t, n, a) {
...
function $s(e, t) {
    ...
    let a = 0,
        r = n.indexOf(t);
    for (; r !== -1; ) (a++, (r = n.indexOf(t, r + t.length)));
    return a;
}
function Yh(e, t) {
    const n = t || {};
...
function il(e) {
    return t;
    function t(n, a, r) {
        const i = n ? n.children : Qh;
        let s = (a || 0) + e,
            o = i[s];
        if (!r) for (; o && Ci(o); ) ((s += e), (o = i[s]));
        return o;
    }
}
...
function sl(e) {
    return t;
    function t(n, a, r) {
        return Jh.call(e, n.tagName) && e[n.tagName](n, a, r);
    }
}
const Ei = sl({
    body: tg,
...
function Ja(e, t, n) {
    ...
    return (
        !a ||
        (a.type !== 'comment' && !(a.type === 'text' && Ci(a.value.charAt(0))))
    );
}
function eg(e, t, n) {
    const a = Z(n, t);
...
function ig(e, t, n) {
    ...
    return (
        !a ||
        (a.type === 'element' && (a.tagName === 'dt' || a.tagName === 'dd'))
    );
}
function Ss(e, t, n) {
    const a = Z(n, t);
    return (
        !a ||
        (a.type === 'element' && (a.tagName === 'rp' || a.tagName === 'rt'))
    );
}
function sg(e, t, n) {
    const a = Z(n, t);
...
function As(e, t, n) {
    ...
    return (
        !a ||
        (a.type === 'element' && (a.tagName === 'td' || a.tagName === 'th'))
    );
}
const dg = sl({ body: gg, colgroup: fg, head: hg, html: mg, tbody: bg });
function mg(e) {
    const t = Z(e, -1);
...
function gg(e) {
    ...
    return (
        !t ||
        (t.type !== 'comment' &&
            !(t.type === 'text' && Ci(t.value.charAt(0))) &&
            !(
                t.type === 'element' &&
                (t.tagName === 'meta' ||
                    t.tagName === 'link' ||
...
function _g(e, t, n, a) {
    const r = a.schema,
        i = r.space === 'svg' ? !1 : a.settings.omitOptionalTags;
    let s =
        r.space === 'svg'
            ? a.settings.closeEmptyElements
            : a.settings.voids.includes(e.tagName.toLowerCase());
    const o = [];
    let c;
    r.space === 'html' && e.tagName === 'svg' && (a.schema = nl);
    const l = yg(a, e.properties),
        u = a.all(
    ...
    return (
        ...
        (l || !i || !dg(e, t, n)) &&
            ...
            s &&
                (r.space === 'svg' || a.settings.closeSelfClosing) &&
...
function yg(e, t) {
    ...
    for (; ++a < n.length; ) {
        const i = e.settings.tightAttributes
            ? n[a].charAt(n[a].length - 1)
            : void 0;
        a !== n.length - 1 && i !== '"' && i !== "'" && (n[a] += ' ');
    }
    return n.join('');
}
function vg(e, t, n) {
    const a = kh(e.schema, t),
        r = e.settings.allowParseErrors && e.schema.space === 'html' ? 0 : 1,
        i = e.settings.allowDangerousCharacters ? 0 : 1;
    let s = e.quote,
        o;
    if (
        (a.overloadedBoolean && (n === a.attribute || n === '')
            ? (n = !0)
            : (a.boolean || a.overloadedBoolean) &&
              (typeof n != 'string' || n === a.attribute || n === '') &&
              (n = !!n),
    ...
    return n === !0 ||
        ...
        : (e.settings.preferUnquoted &&
              (o = St(
                  ...
                  Object.assign({}, e.settings.characterReferences, {
                      attribute: !0,
                      subset: Yn.unquoted[r][i],
                  }),
              )),
          o !== n &&
              (e.settings.quoteSmart &&
                  $s(n, s) > $s(n, e.alternative) &&
                  (s = e.alternative),
              (o =
                  s +
                  St(
                      n,
                      Object.assign({}, e.settings.characterReferences, {
                          subset: (s === "'" ? Yn.single : Yn.double)[r][i],
                          attribute: !0,
                      }),
                  ) +
                  s)),
...
function ol(e, t, n, a) {
    return n &&
        ...
        : St(
              e.value,
              Object.assign({}, a.settings.characterReferences, { subset: wg }),
          );
}
function xg(e, t, n, a) {
    return a.settings.allowDangerousHtml ? e.value : ol(e, t, n, a);
}
function kg(e, t, n, a) {
    return a.all(e);
}
...
function Ag(e, t) {
    ...
    return {
        ...
        settings: {
            ...
            voids: n.voids || bh,
            characterReferences: n.characterReferences || jg,
            closeSelfClosing: n.closeSelfClosing || !1,
            closeEmptyElements: n.closeEmptyElements || !1,
        },
        schema: n.space === 'svg' ? nl : Fh,
        quote: a,
        alternative: r,
    }.one(Array.isArray(e) ? { type: 'root', children: e } : e, void 0, void 0);
}
function Tg(e, t, n) {
    return Cg(e, t, n, this);
}
function Rg(e) {
    const t = [],
        n = (e && e.children) || Sg;
    let a = -1;
    for (; ++a < n.length; ) t[a] = this.one(n[a], a, e);
    return t.join('');
}
function fa(e, t) {
    const n = typeof e == 'string' ? {} : { ...e.colorReplacements },
        a = typeof e == 'string' ? e : e.name;
    for (const [r, i] of Object.entries(t?.colorReplacements || {}))
        typeof i == 'string' ? (n[r] = i) : r === a && Object.assign(n, i);
    return n;
}
function Ge(e, t) {
...
function ll(e, t) {
    ...
    for (const a of n)
        a && !e.properties.class.includes(a) && e.properties.class.push(a);
    return e;
}
function Ra(e, t = !1) {
    const n = e.split(/(\r?\n)/g);
    ...
    for (let i = 0; i < n.length; i += 2) {
        ...
        (r.push([s, a]), (a += n[i].length), (a += n[i + 1]?.length || 0));
    }
    return r;
}
function Lg(e) {
    const t = Ra(e, !0).map(([r]) => r);
    function n(r) {
        if (r === e.length)
    ...
    function a(r, i) {
        let s = 0;
        for (let o = 0; o < r; o++) s += t[o].length;
        return ((s += i), s);
    }
    return { lines: t, indexToPos: n, posToIndex: a };
}
const ji = 'light-dark()',
    Pg = ['color', 'background-color'];
function Dg(e, t) {
    let n = 0;
    const a = [];
    for (const r of t)
    ...
    return (
        n < e.content.length &&
            a.push({ ...e, content: e.content.slice(n), offset: e.offset + n }),
        a
    );
}
function Mg(e, t) {
    const n = Array.from(t instanceof Set ? t : new Set(t)).sort(
        (a, r) => a - r,
    );
    return n.length
        ? e.map((a) =>
              a.flatMap((r) => {
                  const i = n
                      .filter(
                          (s) =>
                              r.offset < s && s < r.offset + r.content.length,
                      )
                      .map((s) => s - r.offset)
                      .sort((s, o) => s - o);
                  return i.length ? Dg(r, i) : r;
              }),
          )
        : e;
}
function qg(e, t, n, a, r = 'css-vars') {
    const i = {
            content: e.content,
            explanation: e.explanation,
            offset: e.offset,
        },
        s = t.map((u) => ba(e.variants[u])),
        o = new Set(s.flatMap((u) => Object.keys(u))),
        c = {},
        l = (u, p) => {
            const d =
                p === 'color' ? '' : p === 'background-color' ? '-bg' : `-${p}`;
            return n + t[u] + (p === 'color' ? '' : d);
        };
    return (
        s.forEach((u, p) => {
            for (const d of o) {
                const m = u[d] || 'inherit';
                if (p === 0 && a && Pg.includes(d))
                    if (a === ji && s.length > 1) {
                        const g = t.findIndex((_) => _ === 'light'),
                            v = t.findIndex((_) => _ === 'dark');
                        if (g === -1 || v === -1)
                            throw new Y(
                                'When using `defaultColor: "light-dark()"`, you must provide both `light` and `dark` themes',
                            );
                        const f = s[g][d] || 'inherit',
                            b = s[v][d] || 'inherit';
                        ((c[d] = `light-dark(${f}, ${b})`),
                            r === 'css-vars' && (c[l(p, d)] = m));
                    } else c[d] = m;
                else r === 'css-vars' && (c[l(p, d)] = m);
            }
        }),
        (i.htmlStyle = c),
        i
...
function ba(e) {
    ...
    if (
        ...
        (e.fontStyle & ee.Italic && (t['font-style'] = 'italic'),
            e.fontStyle & ee.Bold && (t['font-weight'] = 'bold'));
        const n = [];
        (e.fontStyle & ee.Underline && n.push('underline'),
            e.fontStyle & ee.Strikethrough && n.push('line-through'),
...
class Ut {
    ...
    static initial(t, n) {
        return new Ut(Object.fromEntries(Og(n).map((a) => [a, Nr])), t);
    }
    constructor(...t) {
        if (t.length === 2) {
            const [n, a] = t;
...
function zg(e) {
    ...
    function a(r) {
        if (n.has(r)) return;
        n.add(r);
        const i = r?.nameScopesList?.scopeName;
        (i && t.push(i), r.parent && a(r.parent));
    }
    return (a(e), t);
}
function Bg(e, t) {
    if (!(e instanceof Ut)) throw new Y('Invalid grammar state');
...
function Ug() {
            ...
            let a = function (s) {
                if (typeof s == 'number') {
                    if (s < 0 || s > n.source.length)
                        throw new Y(
                            `Invalid decoration offset: ${s}. Code length: ${n.source.length}`,
                        );
                    ...
                    if (o === void 0)
                        throw new Y(
                            `Invalid decoration position ${JSON.stringify(s)}. Lines length: ${r.lines.length}`,
                        );
                    let c = s.character;
                    if ((c < 0 && (c = o.length + c), c < 0 || c > o.length))
                        throw new Y(
                            `Invalid decoration position ${JSON.stringify(s)}. Line ${s.line} length: ${o.length}`,
                        );
                    return {
                        ...s,
                        character: c,
                        offset: r.posToIndex(s.line, c),
                    };
                }
            };
            const r = Lg(n.source),
                i = (n.options.decorations || []).map((s) => ({
                    ...s,
                    start: a(s.start),
                    end: a(s.end),
                }));
    ...
    return {
        ...
        tokens(n) {
            ...
            const r = t(this).decorations.flatMap((s) => [
                s.start.offset,
                s.end.offset,
            ]);
            return Mg(n, r);
        ...
        code(n) {
            if (!this.options.decorations?.length) return;
            const a = t(this),
                r = Array.from(n.children).filter(
                    (u) => u.type === 'element' && u.tagName === 'span',
                );
            if (r.length !== a.converter.lines.length)
                throw new Y(
                    `Number of lines in code element (${r.length}) does not match the number of lines in the source (${a.converter.lines.length}). Failed to apply decorations.`,
                );
            function i(u, p, d, m) {
                const g = r[u];
                let v = '',
                ...
                if (
                    (p === 0 && (f = 0),
                    d === 0 && (b = 0),
                    d === Number.POSITIVE_INFINITY && (b = g.children.length),
                    f === -1 || b === -1)
                )
                    for (let w = 0; w < g.children.length; w++)
                        ((v += pl(g.children[w])),
                            f === -1 && v.length === p && (f = w + 1),
                            b === -1 && v.length === d && (b = w + 1));
                if (f === -1)
                    throw new Y(
                        `Failed to find start index for decoration ${JSON.stringify(m.start)}`,
                    );
                if (b === -1)
                    throw new Y(
                        `Failed to find end index for decoration ${JSON.stringify(m.end)}`,
                    );
                const _ = g.children.slice(f, b);
                if (!m.alwaysWrap && _.length === g.children.length)
                    o(g, m, 'line');
                else if (
                    !m.alwaysWrap &&
                    _.length === 1 &&
                    ...
                    (o(w, m, 'wrapper'), g.children.splice(f, _.length, w));
                }
            }
            function s(u, p) {
                r[u] = o(r[u], p, 'line');
            ...
            function o(u, p, d) {
                ...
                return (
                    ...
                    p.properties?.class && ll(u, p.properties.class),
                    (u = g(u, d) || u),
                    u
                );
            }
            const c = [],
                l = a.decorations.sort(
                    (u, p) =>
                        p.start.offset - u.start.offset ||
                        u.end.offset - p.end.offset,
                );
            for (const u of l) {
                const { start: p, end: d } = u;
                if (p.line === d.line) i(p.line, p.character, d.character, u);
                else if (p.line < d.line) {
                    i(p.line, p.character, Number.POSITIVE_INFINITY, u);
                    for (let m = p.line + 1; m < d.line; m++)
                        c.unshift(() => s(m, u));
...
function Gg(e) {
    for (let t = 0; t < e.length; t++) {
        ...
        for (let a = t + 1; a < e.length; a++) {
            const r = e[a],
                i =
                    n.start.offset <= r.start.offset &&
                    r.start.offset < n.end.offset,
                s =
                    n.start.offset < r.end.offset &&
                    r.end.offset <= n.end.offset,
                o =
                    r.start.offset <= n.start.offset &&
                    n.start.offset < r.end.offset,
                c =
                    r.start.offset < n.end.offset &&
                    n.end.offset <= r.end.offset;
            if (i || s || o || c) {
                if (
                    (i && s) ||
                    (o && c) ||
...
function pl(e) {
    return e.type === 'text'
        ? e.value
        : e.type === 'element'
          ? e.children.map(pl).join('')
          : '';
}
const Hg = [Ug()];
function _a(e) {
    const t = Wg(e.transformers || []);
    return [...t.pre, ...t.normal, ...t.post, ...Hg];
}
function Wg(e) {
    const t = [],
        n = [],
...
function Vg(e, t) {
    ...
    if (n !== -1 && e[n + 1] === '[') {
        const a = e.indexOf('m', n);
        if (a !== -1)
            return {
                sequence: e.substring(n + 2, a).split(';'),
                startPosition: n,
                position: a + 1,
            };
    }
...
function Ts(e) {
    const t = e.shift();
    if (t === '2') {
        const n = e.splice(0, 3).map((a) => Number.parseInt(a));
        return n.length !== 3 || n.some((a) => Number.isNaN(a))
            ? void 0
            : { type: 'rgb', rgb: n };
    } else if (t === '5') {
        const n = e.shift();
    ...
    for (; e.length > 0; ) {
        ...
        if (!Number.isNaN(a))
            if (a === 0) t.push({ type: 'resetAll' });
                ...
                er[a] && t.push({ type: 'setDecoration', value: er[a] });
            else if (a <= 29) {
                const r = er[a - 20];
                r &&
                    (t.push({ type: 'resetDecoration', value: r }),
                    r === 'dim' &&
                        t.push({ type: 'resetDecoration', value: 'bold' }));
            } else if (a <= 37)
                t.push({
                    type: 'setForegroundColor',
                    value: { type: 'named', name: it[a - 30] },
                });
            else if (a === 38) {
                const r = Ts(e);
                r && t.push({ type: 'setForegroundColor', value: r });
            } else if (a === 39) t.push({ type: 'resetForegroundColor' });
            else if (a <= 47)
                t.push({
                    type: 'setBackgroundColor',
                    value: { type: 'named', name: it[a - 40] },
                });
            else if (a === 48) {
                const r = Ts(e);
                r && t.push({ type: 'setBackgroundColor', value: r });
            } else
                a === 49
                    ...
                    : a === 53
                      ...
                      : a === 55
                        ...
                        : a >= 90 && a <= 97
                          ? t.push({
                                type: 'setForegroundColor',
                                value: { type: 'named', name: it[a - 90 + 8] },
                            })
                          : a >= 100 &&
                            a <= 107 &&
                            t.push({
                                type: 'setBackgroundColor',
                                value: { type: 'named', name: it[a - 100 + 8] },
                            });
    }
    return t;
}
...
function Kg(e = Xg) {
    ...
    function n(o) {
        return `#${o.map((c) => Math.max(0, Math.min(c, 255)).toString(16).padStart(2, '0')).join('')}`;
    }
    let a;
    function r() {
        if (a) return a;
        a = [];
        for (let l = 0; l < it.length; l++) a.push(t(it[l]));
        let o = [0, 95, 135, 175, 215, 255];
        for (let l = 0; l < 6; l++)
            for (let u = 0; u < 6; u++)
                for (let p = 0; p < 6; p++) a.push(n([o[l], o[u], o[p]]));
        let c = 8;
        for (let l = 0; l < 24; l++, c += 10) a.push(n([c, c, c]));
        return a;
    }
    function i(o) {
        return r()[o];
        ...
        i = Kg(
            Object.fromEntries(
                it.map((o) => [
                    o,
                    e.colors?.[
                        `terminal.ansi${o[0].toUpperCase()}${o.substring(1)}`
                    ],
                ]),
            ),
        ),
    ...
    return r.map((o) =>
        s.parse(o[0]).map((c) => {
            ...
            (c.decorations.has('reverse')
                ? ((l = c.background ? i.value(c.background) : e.bg),
                  (u = c.foreground ? i.value(c.foreground) : e.fg))
                : ((l = c.foreground ? i.value(c.foreground) : e.fg),
                  (u = c.background ? i.value(c.background) : void 0)),
                (l = Ge(l, a)),
                (u = Ge(u, a)),
                c.decorations.has('dim') && (l = Jg(l)));
            let p = ee.None;
            return (
                c.decorations.has('bold') && (p |= ee.Bold),
                c.decorations.has('italic') && (p |= ee.Italic),
                c.decorations.has('underline') && (p |= ee.Underline),
                c.decorations.has('strikethrough') && (p |= ee.Strikethrough),
                {
                    content: c.value,
                    offset: o[1],
                    color: l,
...
function Si(e, t, n = {}) {
    const { lang: a = 'text', theme: r = e.getLoadedThemes()[0] } = n;
    if (Fi(a) || $i(r))
        return Ra(t).map((c) => [{ content: c[0], offset: c[1] }]);
    const { theme: i, colorMap: s } = e.setTheme(r);
    if (a === 'ansi') return Qg(i, t, n);
    const o = e.getLanguage(a);
    if (n.grammarState) {
        if (n.grammarState.lang !== o.name)
            throw new Y(
                `Grammar state language "${n.grammarState.lang}" does not match highlight language "${o.name}"`,
            );
        if (!n.grammarState.themes.includes(i.name))
            throw new Y(
                `Grammar state themes "${n.grammarState.themes}" do not contain highlight theme "${i.name}"`,
            );
    }
    return tf(t, o, i, s, n);
}
function ef(...e) {
    if (e.length === 2) return _n(e[1]);
    const [t, n, a = {}] = e,
        { lang: r = 'text', theme: i = t.getLoadedThemes()[0] } = a;
    if (Fi(r) || $i(i))
        throw new Y('Plain language does not have grammar state');
    if (r === 'ansi') throw new Y('ANSI language does not have grammar state');
    const { theme: s, colorMap: o } = t.setTheme(i),
        c = t.getLanguage(r);
    return new Ut(ya(n, c, s, o, a).stateStack, c.name, s.name);
}
function tf(e, t, n, a, r) {
    const i = ya(e, t, n, a, r),
        s = new Ut(ya(e, t, n, a, r).stateStack, t.name, n.name);
    return (Oa(i.tokens, s), i.tokens);
}
function ya(e, t, n, a, r) {
    const i = fa(n, r),
        { tokenizeMaxLineLength: s = 0, tokenizeTimeLimit: o = 500 } = r,
        c = Ra(e);
    let l = r.grammarState
            ? (Bg(r.grammarState, n.name) ?? Nr)
            : r.grammarContextCode != null
              ? ya(r.grammarContextCode, t, n, a, {
                    ...r,
                    grammarState: void 0,
    ...
    for (let d = 0, m = c.length; d < m; d++) {
        ...
        if (s > 0 && g.length >= s) {
            ((u = []),
                p.push([{ content: g, offset: v, color: '', fontStyle: 0 }]));
            continue;
        }
        let f, b, _;
        r.includeExplanation &&
            ((f = t.tokenizeLine(g, l, o)), (b = f.tokens), (_ = 0));
        const w = t.tokenizeLine2(g, l, o),
            h = w.tokens.length / 2;
        for (let C = 0; C < h; C++) {
            const k = w.tokens[2 * C],
                $ = C + 1 < h ? w.tokens[2 * C + 2] : g.length;
            if (k === $) continue;
            const T = w.tokens[2 * C + 1],
                N = Ge(a[Lt.getForeground(T)], i),
                I = Lt.getFontStyle(T),
                D = {
                    content: g.substring(k, $),
                    offset: v + k,
                    color: N,
                    fontStyle: I,
                };
            if (r.includeExplanation) {
                ...
                if (r.includeExplanation !== 'scopeName')
                    for (const q of n.settings) {
                        let U;
                        switch (typeof q.scope) {
                            case 'string':
                                U = q.scope.split(/,/).map((G) => G.trim());
                                break;
                            case 'object':
                                U = q.scope;
                                break;
                ...
                for (; k + L < $; ) {
                    const q = b[_],
                        U = g.substring(q.startIndex, q.endIndex);
                    ((L += U.length),
                        D.explanation.push({
                            content: U,
                            scopes:
                                r.includeExplanation === 'scopeName'
                                    ? nf(q.scopes)
                                    : af(R, q.scopes),
                        }),
                        (_ += 1));
        ...
        (p.push(u), (u = []), (l = w.ruleStack));
    }
    return { tokens: p, stateStack: l };
}
function nf(e) {
...
function af(e, t) {
    ...
    for (let a = 0, r = t.length; a < r; a++) {
        const i = t[a];
        n[a] = { scopeName: i, themeMatches: sf(e, i, t.slice(0, a)) };
    }
    return n;
}
function Rs(e, t) {
...
function rf(e, t, n) {
    if (!Rs(e[e.length - 1], t)) return !1;
    let a = e.length - 2,
        r = n.length - 1;
    for (; a >= 0 && r >= 0; ) (Rs(e[a], n[r]) && (a -= 1), (r -= 1));
    return a === -1;
}
function sf(e, t, n) {
    const a = [];
...
function dl(e, t, n) {
    const a = Object.entries(n.themes)
            .filter((c) => c[1])
            .map((c) => ({ color: c[0], theme: c[1] })),
        r = a.map((c) => {
            const l = Si(e, t, { ...n, theme: c.theme }),
                u = _n(l),
                p = typeof c.theme == 'string' ? c.theme : c.theme.name;
            return { tokens: l, state: u, theme: p };
        }),
        i = of(...r.map((c) => c.tokens)),
        s = i[0].map((c, l) =>
            c.map((u, p) => {
                const d = {
                    content: u.content,
        ...
        o = r[0].state
            ? new Ut(
                  Object.fromEntries(
                      r.map((c) => [
                          c.theme,
                          c.state?.getInternalStack(c.theme),
                      ]),
                  ),
                  r[0].state.lang,
              )
...
function of(...e) {
    ...
    for (let a = 0; a < e[0].length; a++) {
        const r = e.map((c) => c[a]),
            i = t.map(() => []);
        t.forEach((c, l) => c.push(i[l]));
        const s = r.map(() => 0),
            o = r.map((c) => c[0]);
        for (; o.every((c) => c); ) {
            const c = Math.min(...o.map((l) => l.content.length));
            for (let l = 0; l < n; l++) {
                const u = o[l];
                u.content.length === c
                    ? (i[l].push(u), (s[l] += 1), (o[l] = r[l][s[l]]))
                    : (i[l].push({ ...u, content: u.content.slice(0, c) }),
                      (o[l] = {
                          ...u,
                          content: u.content.slice(c),
                          offset: u.offset + c,
                      }));
            }
        }
    ...
    if ('themes' in n) {
        const {
            ...
            d = Object.entries(n.themes)
                .filter((b) => b[1])
                .map((b) => ({ color: b[0], theme: b[1] }))
                .sort((b, _) => (b.color === l ? -1 : _.color === l ? 1 : 0));
        if (d.length === 0) throw new Y('`themes` option must not be empty');
        const m = dl(e, t, n);
        if (((c = _n(m)), l && ji !== l && !d.find((b) => b.color === l)))
            throw new Y(
                `\`themes\` option must contain the defaultColor key \`${l}\``,
            );
        const g = d.map((b) => e.getTheme(b.theme)),
            v = d.map((b) => b.color);
        ((i = m.map((b) => b.map((_) => qg(_, v, u, l, p)))), c && Oa(i, c));
        const f = d.map((b) => fa(b.theme, n));
        ((r = Os(d, g, f, u, l, 'fg', p)),
            (a = Os(d, g, f, u, l, 'bg', p)),
            (s = `shiki-themes ${g.map((b) => b.name).join(' ')}`),
            (o = l ? void 0 : [r, a].join(';')));
    } else if ('theme' in n) {
        const l = fa(n.theme, n);
        i = Si(e, t, n);
        const u = e.getTheme(n.theme);
        ((a = Ge(u.bg, l)), (r = Ge(u.fg, l)), (s = u.name), (c = _n(i)));
    } else
        throw new Y(
...
function Os(e, t, n, a, r, i, s) {
    return e
        .map((o, c) => {
            const l = Ge(t[c][i], n[c]) || 'inherit',
                u = `${a + o.color}${i === 'bg' ? '-bg' : ''}:${l}`;
            if (c === 0 && r) {
                if (r === ji && e.length > 1) {
                    const p = e.findIndex((v) => v.color === 'light'),
                        d = e.findIndex((v) => v.color === 'dark');
                    if (p === -1 || d === -1)
                        throw new Y(
                            'When using `defaultColor: "light-dark()"`, you must provide both `light` and `dark` themes',
                        );
                    const m = Ge(t[p][i], n[p]) || 'inherit',
                        g = Ge(t[d][i], n[d]) || 'inherit';
                    return `light-dark(${m}, ${g});${u}`;
                }
                return l;
            }
...
function wa(
    ...
    a = {
        meta: {},
        options: n,
        codeToHast: (r, i) => wa(e, r, i),
        codeToTokens: (r, i) => va(e, r, i),
    },
) {
    let r = t;
    for (const g of _a(n)) r = g.preprocess?.call(a, r, n) || r;
    let {
        tokens: i,
        fg: s,
        bg: o,
    ...
    const { mergeWhitespaces: p = !0, mergeSameStyleTokens: d = !1 } = n;
    (p === !0 ? (i = lf(i)) : p === 'never' && (i = uf(i)), d && (i = pf(i)));
    const m = {
        ...a,
        get source() {
            return r;
    ...
    for (const g of _a(n)) i = g.tokens?.call(m, i) || i;
    return cf(i, { ...n, fg: s, bg: o, themeName: c, rootStyle: l }, m, u);
}
function cf(e, t, n, a = _n(e)) {
    const r = _a(t),
        i = [],
        s = { type: 'root', children: [] },
        { structure: o = 'classic', tabindex: c = '0' } = t;
    let l = {
            type: 'element',
            tagName: 'pre',
            properties: {
        ...
        u = { type: 'element', tagName: 'code', properties: {}, children: i };
    const p = [],
        d = {
            ...n,
            structure: o,
...
`,
            ...
            for (const _ of g) {
                ...
                const h = qr(_.htmlStyle || ba(_));
                h && (w.properties.style = h);
                for (const C of r) w = C?.span?.call(d, w, v + 1, b, f, _) || w;
                (o === 'inline'
                    ? s.children.push(w)
                    : o === 'classic' && f.children.push(w),
                    (b += _.content.length));
            }
            if (o === 'classic') {
                for (const _ of r) f = _?.line?.call(d, f, v + 1) || f;
                (p.push(f), i.push(f));
            }
        }),
        o === 'classic')
    ) {
        for (const g of r) u = g?.code?.call(d, u) || u;
        l.children.push(u);
        for (const g of r) l = g?.pre?.call(d, l) || l;
        s.children.push(l);
    }
    let m = s;
    for (const g of r) m = g?.root?.call(d, m) || m;
    return (a && Oa(m, a), m);
}
function lf(e) {
    return e.map((t) => {
        ...
        return (
            t.forEach((i, s) => {
                const c = !(
                    i.fontStyle &&
                    (i.fontStyle & ee.Underline ||
                        i.fontStyle & ee.Strikethrough)
                );
                c && i.content.match(/^\s+$/) && t[s + 1]
                    ? (r || (r = i.offset), (a += i.content))
                    : a
                      ? (c
                            ? n.push({
                                  ...i,
...
function uf(e) {
    return e.map((t) =>
        t.flatMap((n) => {
            ...
            const a = n.content.match(/^(\s*)(.*?)(\s*)$/);
            if (!a) return n;
            const [, r, i, s] = a;
            if (!r && !s) return n;
            const o = [{ ...n, offset: n.offset + r.length, content: i }];
            return (
                r && o.unshift({ content: r, offset: n.offset }),
                s &&
                    o.push({
                        content: s,
    ...
    return e.map((t) => {
        ...
        for (const a of t) {
            ...
            const r = n[n.length - 1],
                i = qr(r.htmlStyle || ba(r)),
                s = qr(a.htmlStyle || ba(a)),
                o =
                    r.fontStyle &&
                    (r.fontStyle & ee.Underline ||
                        r.fontStyle & ee.Strikethrough),
                c =
                    a.fontStyle &&
                    (a.fontStyle & ee.Underline ||
                        a.fontStyle & ee.Strikethrough);
            !o && !c && i === s ? (r.content += a.content) : n.push({ ...a });
        }
        return n;
    });
}
...
function mf(e, t, n) {
    const a = {
        meta: {},
        options: n,
        codeToHast: (i, s) => wa(e, i, s),
        codeToTokens: (i, s) => va(e, i, s),
    };
    let r = df(wa(e, t, n, a));
    for (const i of _a(n)) r = i.postprocess?.call(a, r, n) || r;
    return r;
}
const Is = { light: '#333333', dark: '#bbbbbb' },
    Ns = { light: '#fffffe', dark: '#1e1e1e' },
    Ls = '__shiki_resolved';
function Ai(e) {
    if (e?.[Ls]) return e;
    const t = { ...e };
    ...
    if (!n || !a) {
        const o = t.settings
            ? t.settings.find((c) => !c.name && !c.scope)
            : void 0;
        (o?.settings?.foreground && (a = o.settings.foreground),
            o?.settings?.background && (n = o.settings.background),
            !a &&
            ...
            a || (a = t.type === 'light' ? Is.light : Is.dark),
            n || (n = t.type === 'light' ? Ns.light : Ns.dark),
            (t.fg = a),
            (t.bg = n));
    }
    ...
    function s(o) {
        ...
        r += 1;
        const c = `#${r.toString(16).padStart(8, '0').toLowerCase()}`;
        return t.colorReplacements?.[`#${c}`] ? s(o) : (i.set(o, c), c);
    }
    t.settings = t.settings.map((o) => {
        const c =
                o.settings?.foreground &&
                !o.settings.foreground.startsWith('#'),
            l =
                o.settings?.background &&
                !o.settings.background.startsWith('#');
        if (!c && !l) return o;
        const u = { ...o, settings: { ...o.settings } };
        if (c) {
            const p = s(o.settings.foreground);
            ((t.colorReplacements[p] = o.settings.foreground),
                (u.settings.foreground = p));
        }
        if (l) {
            const p = s(o.settings.background);
            ((t.colorReplacements[p] = o.settings.background),
                (u.settings.background = p));
        }
        return u;
    });
    for (const o of Object.keys(t.colors || {}))
        if (
            (o === 'editor.foreground' ||
                o === 'editor.background' ||
                o.startsWith('terminal.ansi')) &&
            !t.colors[o]?.startsWith('#')
        ) {
            const c = s(t.colors[o]);
            ((t.colorReplacements[c] = t.colors[o]), (t.colors[o] = c));
        }
    return (
...
async function gf(e) {
    return (
        await Promise.all(e.map(async (n) => (Ng(n) ? null : Ai(await cl(n)))))
    ).filter((n) => !!n);
}
...
class ff extends fh {
    constructor(t, n, a, r = {}) {
        (super(t),
            ...
            (this._langs = a),
            (this._alias = r),
            this._themes.map((i) => this.loadTheme(i)),
    ...
    setTheme(t) {
        ...
        (n ||
            ((n = pa.createFromRawTheme(t)),
            this._textmateThemeCache.set(t, n)),
    ...
    loadLanguage(t) {
        ...
        const n = new Set(
            [...this._langMap.values()].filter((i) =>
                i.embeddedLangsLazy?.includes(t.name),
            ),
        );
        ...
        const r = this.loadGrammarWithConfiguration(t.scopeName, 1, a);
        if (
            ((r.name = t.name),
            this._resolvedGrammars.set(t.name, r),
            t.aliases &&
                t.aliases.forEach((i) => {
                    this._alias[i] = t.name;
                }),
            (this._loadedLanguagesCache = null),
            n.size)
        )
            for (const i of n)
                (this._resolvedGrammars.delete(i.name),
                    (this._loadedLanguagesCache = null),
                    this._syncRegistry?._injectionGrammars?.delete(i.scopeName),
                    this._syncRegistry?._grammars?.delete(i.scopeName),
                    this.loadLanguage(this._langMap.get(i.name)));
    }
    dispose() {
        (super.dispose(),
        ...
        if (a.length) {
            const r = n
                .filter(
                    ([i, s]) =>
                        s &&
                        s.embeddedLangs?.some((o) =>
                            a.map(([c]) => c).includes(o),
                        ),
                )
                .filter((i) => !a.includes(i));
            throw new $t(
                `Missing languages ${a.map(([i]) => `\`${i}\``).join(', ')}, required by ${r.map(([i]) => `\`${i}\``).join(', ')}`,
            );
        }
...
class bf {
    ...
    constructor(t, n) {
        ((this._onigLib = {
            ...
            n.forEach((a) => this.addLanguage(a)));
    }
    get onigLib() {
            ...
            t.injectTo &&
                t.injectTo.forEach((n) => {
                    (this._injections.get(n) || this._injections.set(n, []),
                        this._injections.get(n).push(t.scopeName));
                }));
    }
    getInjections(t) {
        const n = t.split('.');
...
function _f(e) {
    ((tn += 1),
        e.warnings !== !1 &&
            ...
            tn % 10 === 0 &&
            console.warn(
                `[Shiki] ${tn} instances have been created. Shiki is supposed to be used as a singleton, consider refactoring your code to cache your highlighter instance; Or call \`highlighter.dispose()\` to release unused instances.`,
            ));
    let t = !1;
    if (!e.engine)
        throw new $t('`engine` option is required for synchronous mode');
    const n = (e.langs || []).flat(1),
        a = (e.themes || []).flat(1).map(Ai),
        r = new bf(e.engine, n),
        i = new ff(r, a, n, e.langAlias);
    let s;
    function o(_) {
        f();
        ...
        if (!w)
            throw new $t(
                `Language \`${_}\` not found, you may need to load it first`,
            );
        return w;
    }
    function c(_) {
        ...
        if (!w)
            throw new $t(
                `Theme \`${_}\` not found, you may need to load it first`,
            );
        return w;
    }
    function l(_) {
        ...
        const h = i.getColorMap();
        return { theme: w, colorMap: h };
    }
    function u() {
        return (f(), i.getLoadedThemes());
    }
    function p() {
        return (f(), i.getLoadedLanguages());
    }
    function d(..._) {
        (f(), i.loadLanguages(_.flat(1)));
    }
    async function m(..._) {
        return d(await hf(_));
    }
    function g(..._) {
        f();
        for (const w of _.flat(1)) i.loadTheme(w);
    }
    async function v(..._) {
        return (f(), g(await gf(_)));
    }
    function f() {
        if (t) throw new $t('Shiki instance has been disposed');
    }
    function b() {
        t || ((t = !0), i.dispose(), (tn -= 1));
    }
    return {
        setTheme: l,
        getTheme: c,
...
function yf(e) {
    const t = _f(e);
    return {
        getLastGrammarState: (...n) => ef(t, ...n),
        codeToTokensBase: (n, a) => Si(t, n, a),
        codeToTokensWithThemes: (n, a) => dl(t, n, a),
        codeToTokens: (n, a) => va(t, n, a),
        codeToHast: (n, a) => wa(t, n, a),
        codeToHtml: (n, a) => mf(t, n, a),
        getBundledLanguages: () => ({}),
        getBundledThemes: () => ({}),
        ...t,
...
const ml = X`\[\^?`,
    hl = `c.? | C(?:-.?)?|${X`[pP]\{(?:\^?[-\x20_]*[A-Za-z][-\x20\w]*\})?`}|${X`x[89A-Fa-f]\p{AHex}(?:\\x[89A-Fa-f]\p{AHex})*`}|${X`u(?:\p{AHex}{4})? | x\{[^\}]*\}? | x\p{AHex}{0,2}`}|${X`o\{[^\}]*\}?`}|${X`\d{1,3}`}`,
    Ri = /[?*+][?+]?|\{(?:\d+(?:,\d*)?|,\d+)\}\??/,
    Xn = new RegExp(
        X`
  \\ (?:
...
function wf(e, t = {}) {
    ...
    let s = [],
        o;
    for (Xn.lastIndex = 0; (o = Xn.exec(e)); ) {
        const p = xf(i, e, o[0], Xn.lastIndex);
        (p.tokens ? s.push(...p.tokens) : p.token && s.push(p.token),
            p.lastIndex !== void 0 && (Xn.lastIndex = p.lastIndex));
    }
    const c = [];
    let l = 0;
    (s
        .filter((p) => p.type === 'GroupOpen')
        .forEach((p) => {
            p.kind === 'capturing'
                ? (p.number = ++l)
                : p.raw === '(' && c.push(p);
    ...
    return {
        tokens: s
            .map((p) => (p.type === 'EscapedNumber' ? Bf(p, u) : p))
            .flat(),
        flags: a,
    };
}
function xf(e, t, n, a) {
    ...
    if (r === '\\') {
        if ('AbBGyYzZ'.includes(i)) return { token: Ps(n, n) };
        if (/^\\g[<']/.test(n)) {
            if (!/^\\g(?:<[^>]+>|'[^']+')$/.test(n))
        ...
        if (i === 'K') return { token: bl('keep', n) };
        if (i === 'N' || i === 'R')
            return { token: st('newline', n, { negate: i === 'N' }) };
        if (i === 'O') return { token: st('any', n) };
        if (i === 'X') return { token: st('text_segment', n) };
        const s = gl(n, { inCharClass: !1 });
        return Array.isArray(s) ? { tokens: s } : { token: s };
    }
    if (r === '(') {
        if (i === '*') return { token: Pf(n) };
        if (n === '(?{') throw new Error(`Unsupported callout "${n}"`);
        if (n.startsWith('(?#')) {
            if (t[a] !== ')') throw new Error('Unclosed comment group "(?#"');
            return { lastIndex: a + 1 };
        }
        if (/^\(\?[-imx]+[:)]$/.test(n)) return { token: Lf(n, e) };
        if (
            (e.pushModX(e.getCurrentModX()),
            e.numOpenGroups++,
            (n === '(' && !e.captureGroup) || n === '(?:')
        )
            return { token: Et('group', n) };
        if (n === '(?>') return { token: Et('atomic', n) };
        if (n === '(?=' || n === '(?!' || n === '(?<=' || n === '(?<!')
            return {
                token: Et(n[2] === '<' ? 'lookbehind' : 'lookahead', n, {
                    negate: n.endsWith('!'),
                }),
            };
        if (
        ...
        if (n.startsWith('(?~')) {
            ...
            return { token: Et('absence_repeater', n) };
        }
        throw n === '(?('
...
`,
        ...
        if (/^\s$/.test(n)) {
            ...
            return (
                (s.lastIndex = a),
                { lastIndex: s.exec(t) ? s.lastIndex : a }
            );
        }
    }
    if (n === '.') return { token: st('dot', n) };
    if (n === '^' || n === '$') {
        const s = e.singleline ? { '^': X`\A`, $: X`\Z` }[n] : n;
        return { token: Ps(s, n) };
    }
    return n === '|'
        ? { token: Ef(n) }
...
function kf(e, t, n) {
    ...
    let r = 1,
        i;
    for (tr.lastIndex = n; (i = tr.exec(e)); ) {
        const s = i[0];
        if (s[0] === '[' && s[1] !== ':') (r++, a.push(Ds(s[1] === '^', s)));
        else if (s === ']') {
            if (a.at(-1).type === 'CharacterClassOpen') a.push(Ne(93, s));
            else if ((r--, a.push(Ff(s)), !r)) break;
        } else {
            const o = Cf(s);
            Array.isArray(o) ? a.push(...o) : a.push(o);
        }
    }
    return { tokens: a, lastIndex: tr.lastIndex || e.length };
}
function Cf(e) {
    if (e[0] === '\\') return gl(e, { inCharClass: !0 });
    if (e[0] === '[') {
        const t = /\[:(?<negate>\^?)(?<name>[a-z]+):\]/.exec(e);
        if (!t || !Ti.has(t.groups.name))
    ...
    return e === '-' ? $f(e) : e === '&&' ? jf(e) : Ne(Gt(e), e);
}
function gl(e, { inCharClass: t }) {
    const n = e[1];
    if (n === 'c' || n === 'C') return Nf(e);
    if ('dDhHsSwW'.includes(n)) return Df(e);
    if (e.startsWith(X`\o{`))
        throw new Error(
    ...
    if (n === 'u' || n === 'x') return Ne(zf(e), e);
    if (Ms.has(n)) return Ne(Ms.get(n), e);
    if (/\d/.test(n)) return Sf(t, e);
    if (e === '\\') throw new Error(X`Incomplete escape "\"`);
    if (n === 'M') throw new Error(`Unsupported meta "${e}"`);
    if ([...e].length === 2) return Ne(e.codePointAt(1), e);
...
function bl(e, t, n = {}) {
    return e === 'keep'
        ...
        : { type: 'Directive', kind: e, flags: Ht(n.flags), raw: t };
}
function Sf(e, t) {
...
function Tf(e, t, n, a) {
    return { type: 'NamedCallout', kind: e, tag: t, arguments: n, raw: a };
}
function Rf(e, t, n, a) {
    return { type: 'Quantifier', kind: e, min: t, max: n, raw: a };
}
function Of(e) {
...
function Nf(e) {
    ...
    return Ne(Gt(t.toUpperCase()) - 64, e);
}
function Lf(e, t) {
    let { on: n, off: a } = /^\(\?(?<on>[imx]*)(?:-(?<off>[-imx]*))?/.exec(
        e,
    ).groups;
    a ??= '';
    const r = (t.getCurrentModX() || n.includes('x')) && !a.includes('x'),
        i = zs(n),
        s = zs(a),
        o = {};
    if ((i && (o.enable = i), s && (o.disable = s), e.endsWith(')')))
        return (t.replaceCurrentModX(r), bl('flags', e, { flags: o }));
    if (e.endsWith(':'))
        return (
            t.pushModX(r),
            t.numOpenGroups++,
            Et('group', e, { ...((i || s) && { flags: o }) })
        );
...
function Pf(e) {
    ...
    const { name: n, tag: a, args: r } = t.groups;
    if (!n) throw new Error(`Invalid named callout "${e}"`);
    if (a === '')
        throw new Error(
            `Named callout tag with empty value not allowed "${e}"`,
        );
    const i = r
            ? r
                  .split(',')
            ...
            : [],
        [s, o, c] = i,
        l = If.has(n) ? n.toLowerCase() : 'custom';
    switch (l) {
        case 'fail':
        case 'mismatch':
        case 'skip':
            if (i.length > 0)
                throw new Error(`Named callout arguments not allowed "${i}"`);
            break;
        case 'error':
            if (i.length > 1)
                throw new Error(
                    `Named callout allows only one argument "${i}"`,
                );
            if (typeof s == 'string')
                throw new Error(
                    `Named callout argument must be a number "${s}"`,
                );
            break;
        case 'max':
            if (!i.length || i.length > 2)
                throw new Error(
                    `Named callout must have one or two arguments "${i}"`,
                );
            if (typeof s == 'string' && !/^[A-Za-z_]\w*$/.test(s))
                throw new Error(
                    `Named callout argument one must be a tag or number "${s}"`,
                );
            if (i.length === 2 && (typeof o == 'number' || !/^[<>X]$/.test(o)))
                throw new Error(
                    `Named callout optional argument two must be '<', '>', or 'X' "${o}"`,
                );
            break;
        case 'count':
        case 'total_count':
            ...
            if (i.length === 1 && (typeof s == 'number' || !/^[<>X]$/.test(s)))
                throw new Error(
                    `Named callout optional argument must be '<', '>', or 'X' "${s}"`,
                );
            break;
        case 'cmp':
            if (i.length !== 3)
                throw new Error(
                    `Named callout must have three arguments "${i}"`,
                );
            if (typeof s == 'string' && !/^[A-Za-z_]\w*$/.test(s))
                throw new Error(
                    `Named callout argument one must be a tag or number "${s}"`,
                );
            if (typeof o == 'number' || !/^(?:[<>!=]=|[<>])$/.test(o))
                throw new Error(
                    `Named callout argument two must be '==', '!=', '>', '<', '>=', or '<=' "${o}"`,
                );
    ...
    return Tf(l, a ?? null, r?.split(',') ?? null, e);
}
function qs(e) {
    let t = null,
        n,
    ...
    if (e[0] === '{') {
        ...
        if (
            ((n = +r),
            (a = i === void 0 ? +r : i === '' ? 1 / 0 : +i),
            n > a && ((t = 'possessive'), ([n, a] = [a, n])),
            e.endsWith('?'))
        ) {
            if (t === 'possessive')
                throw new Error(
...
function Df(e) {
    ...
    return st({ d: 'digit', h: 'hex', s: 'space', w: 'word' }[t], e, {
        negate: e[1] !== t,
    });
}
function Mf(e) {
...
function zf(e) {
    ...
    const t =
        e[2] === '{'
            ? new RegExp('^\\\\x\\{\\s*(?<hex>\\p{AHex}+)', 'u').exec(e).groups
                  .hex
            : e.slice(2);
    return parseInt(t, 16);
}
function Bf(e, t) {
    const { raw: n, inCharClass: a } = e,
        r = n.slice(1);
    if (!a && ((r !== '0' && r.length === 1) || (r[0] !== '0' && +r <= t)))
        return [fl(n)];
    const i = [],
        s = r.match(/^[0-7]+|\d/g);
    for (let o = 0; o < s.length; o++) {
        ...
        if (o === 0 && c !== '8' && c !== '9') {
            if (((l = parseInt(c, 8)), l > 127))
                throw new Error(
                    X`Octal encoded byte above 177 unsupported "${n}"`,
                );
        } else l = Gt(c);
        i.push(Ne(l, (o === 0 ? '\\' : '') + c));
    }
    ...
    for (; (a = n.exec(e)); ) {
        ...
        if (r[0] === '{') {
            ...
            if (i) {
                ...
                if (+s > +o && r.endsWith('?')) {
                    (n.lastIndex--, t.push(qs(r.slice(0, -1))));
                    continue;
                }
            }
        }
...
function _l(e, t) {
    ...
    const n = e.body[0];
    return !t || Object.keys(t).every((a) => t[a] === n[a]);
}
function Gf(e) {
...
function yl(e, t = {}) {
    const n = {
        ...
        r = (d, m) => {
            const g = a.tokens[i.nextIndex];
            switch (((i.parent = d), i.nextIndex++, g.type)) {
                case 'Alternator':
                    return ht();
                case 'Assertion':
                    return Wf(g);
                ...
                case 'Character':
                    return Ia(g.value, {
                        useLastValid: !!m.isCheckingRangeEnd,
                    });
                ...
                case 'CharacterSet':
                    return Xf(g, i);
                case 'Directive':
                    return nb(g.kind, { flags: g.flags });
                case 'GroupOpen':
                    return Kf(g, i, m);
                case 'NamedCallout':
                    return rb(g.kind, g.tag, g.arguments);
                case 'Quantifier':
                    return Qf(g, i);
                case 'Subroutine':
                    return Jf(g, i);
                default:
                    throw new Error(`Unexpected token type "${g.type}"`);
            }
        },
        i = {
            capturingGroups: [],
    ...
    for (const { ref: d } of p)
        if (typeof d == 'number') {
            if (d > c.length)
                throw new Error(
                    "Subroutine uses a group number that's not defined",
                );
            d && (c[d - 1].isSubroutined = !0);
        } else if (u.has(d)) {
            if (u.get(d).length > 1)
                throw new Error(
                    X`Subroutine uses a duplicate group name "\g<${d}>"`,
                );
            u.get(d)[0].isSubroutined = !0;
        } else
            throw new Error(
                X`Subroutine uses a group name that's not defined "\g<${d}>"`,
            );
    return s;
}
function Wf({ kind: e }) {
...
function Vf({ raw: e }, t) {
    const n = /^\\k[<']/.test(e),
        a = n ? e.slice(3, -1) : e.slice(1),
        r = (i, s = !1) => {
            const o = t.capturingGroups.length;
            let c = !1;
            if (i > o)
                if (t.skipBackrefValidation) c = !0;
                else
                    throw new Error(
...
function Zf(e, t, n) {
    ...
    if (
        ...
        s &&
        s.type !== 'CharacterClass' &&
        s.type !== 'CharacterClassRange' &&
        o &&
        o.type !== 'CharacterClassOpen' &&
        o.type !== 'CharacterClassClose' &&
        o.type !== 'CharacterClassIntersector'
    ) {
        const c = r(i, { ...n, isCheckingRangeEnd: !0 });
        if (s.type === 'Character' && c.type === 'Character')
            return (i.body.pop(), tb(s, c));
        throw new Error('Invalid character class range');
    }
    return Ia(Gt('-'));
}
function Yf({ negate: e }, t, n) {
    const { tokens: a, walk: r } = t,
        i = a[t.nextIndex],
        s = [ra()];
    let o = Gs(i);
    for (; o.type !== 'CharacterClassClose'; ) {
        if (o.type === 'CharacterClassIntersector')
            (s.push(ra()), t.nextIndex++);
        else {
            const l = s.at(-1);
            l.body.push(r(l, n));
        }
        o = Gs(a[t.nextIndex], i);
    }
    const c = ra({ negate: e });
    return (
        s.length === 1
            ? (c.body = s[0].body)
            : ((c.kind = 'intersection'),
              (c.body = s.map((l) => (l.body.length === 1 ? l.body[0] : l)))),
        t.nextIndex++,
        c
    );
}
function Xf({ kind: e, negate: t, value: n }, a) {
    const {
        normalizeUnknownPropertyNames: r,
        skipPropertyNameValidation: i,
        unicodePropertyMap: s,
    } = a;
    if (e === 'property') {
        const o = Na(n);
        if (Ti.has(o) && !s?.has(o)) ((e = 'posix'), (n = o));
        else
            return Ft(n, {
                negate: t,
                normalizeUnknownPropertyNames: r,
    ...
    return e === 'posix' ? ib(n, { negate: t }) : Ur(e, { negate: t });
}
function Kf(e, t, n) {
    const {
            tokens: a,
        ...
        if (d.type === 'Alternator') (c.body.push(ht()), t.nextIndex++);
            ...
            const m = c.body.at(-1),
                g = o(m, {
                    ...
                    isInNegLookbehind: n.isInNegLookbehind || p,
                });
            if ((m.body.push(g), (u || n.isInLookbehind) && !s)) {
                const v =
                    'Lookbehind includes a pattern not allowed by Oniguruma';
                if (p || n.isInNegLookbehind) {
                    if (Bs(g) || g.type === 'CapturingGroup')
                        throw new Error(v);
                } else if (Bs(g) || (Us(g) && g.negate)) throw new Error(v);
            }
        }
        d = Hs(a[t.nextIndex]);
    }
...
function Qf({ kind: e, min: t, max: n }, a) {
    const r = a.parent,
        i = r.body.at(-1);
    if (!i || !Gf(i)) throw new Error('Quantifier requires a repeatable token');
    const s = wl(e, t, n, i);
    return (r.body.pop(), s);
}
function Jf({ raw: e }, t) {
    const { capturingGroups: n, subroutines: a } = t;
    let r = e.slice(3, -1);
    const i = /^(?<sign>[-+]?)0*(?<num>[1-9]\d*)$/.exec(r);
    if (i) {
        const o = +i.groups.num,
            c = n.length;
        if (
            ((t.hasNumberedRef = !0),
            (r = { '': o, '+': c + o, '-': c + 1 - o }[i.groups.sign]),
            r < 1)
        )
...
function eb(e, t) {
    return { type: 'AbsenceFunction', kind: e, body: jn(t?.body) };
}
function ht(e) {
    return { type: 'Alternative', body: kl(e?.body) };
}
function zr(e, t) {
...
function vl(e, t) {
    const n = { name: void 0, isSubroutined: !1, ...t };
    if (n.name !== void 0 && !cb(n.name))
...
function Ia(e, t) {
    const n = { useLastValid: !1, ...t };
    if (e > 1114111) {
        const a = e.toString(16);
        if (n.useLastValid) e = 1114111;
        else
            throw e > 1310719
                ? new Error(`Invalid code point out of range "\\x{${a}}"`)
                : new Error(
                      `Invalid code point out of range in JS "\\x{${a}}"`,
                  );
    }
...
function nb(e, t = {}) {
    ...
    if (e === 'flags')
        return { type: 'Directive', kind: e, flags: Ht(t.flags) };
...
function ib(e, t) {
    const n = !!t?.negate;
    if (!Ti.has(e)) throw new Error(`Invalid POSIX class "${e}"`);
    return { type: 'CharacterSet', kind: 'posix', value: e, negate: n };
}
function wl(e, t, n, a) {
    if (t > n) throw new Error('Invalid reversed quantifier range');
    return { type: 'Quantifier', kind: e, min: t, max: n, body: a };
}
function sb(e, t) {
    return { type: 'Regex', body: jn(t?.body), flags: e };
}
function xl(e) {
...
function Ft(e, t) {
    ...
    let a = n.unicodePropertyMap?.get(Na(e));
    if (!a) {
        if (n.normalizeUnknownPropertyNames) a = lb(e);
...
function ob({ flags: e, kind: t, name: n, negate: a, number: r }) {
    switch (t) {
        ...
        case 'lookahead':
        case 'lookbehind':
            return at({ behind: t === 'lookbehind', negate: a });
        default:
...
function kl(e) {
    if (e === void 0) e = [];
    else if (!Array.isArray(e) || !e.every((t) => !!t.type))
...
function pn(e, t, n = null) {
    ...
    function r(i, s = null, o = null, c = null) {
        let l = 0,
            u = !1;
        const p = {
                node: i,
                ...
                root: e,
                remove() {
                    (Kn(c).splice(Math.max(0, xt(o) + l), 1), l--, (u = !0));
                },
                removeAllNextSiblings() {
                    return Kn(c).splice(xt(o) + 1);
                },
                removeAllPrevSiblings() {
                    const b = xt(o) + l;
                    return ((l -= b), Kn(c).splice(0, Math.max(0, b)));
                },
                replaceWith(b, _ = {}) {
                    const w = !!_.traverse;
                    (c
                        ? (c[Math.max(0, xt(o) + l)] = b)
                        : (Ht(s, "Can't replace root node")[o] = b),
                        w && r(b, s, o, c),
                        (u = !0));
                },
                replaceWithMultiple(b, _ = {}) {
                    const w = !!_.traverse;
                    if (
                        (Kn(c).splice(Math.max(0, xt(o) + l), 1, ...b),
                        (l += b.length - 1),
                        w)
                    ) {
                        let h = 0;
                        for (let C = 0; C < b.length; C++)
                            h += r(b[C], s, xt(o) + C + h, c);
                    }
                    u = !0;
                },
                skip() {
            ...
            m = t['*'],
            g = t[d],
            v = typeof m == 'function' ? m : m?.enter,
            f = typeof g == 'function' ? g : g?.enter;
        if ((v?.(p, n), f?.(p, n), !u))
            switch (d) {
        ...
        return (g?.exit?.(p, n), m?.exit?.(p, n), l);
    }
    return (r(e), e);
}
function Kn(e) {
...
const ub = String.raw`\(\?(?:[:=!>A-Za-z\-]|<[=!]|\(DEFINE\))`;
function pb(e, t) {
    for (let n = 0; n < e.length; n++) e[n] >= t && e[n]++;
}
function db(e, t, n, a) {
    return e.slice(0, t) + a + e.slice(t + n.length);
}
const de = Object.freeze({ DEFAULT: 'DEFAULT', CHAR_CLASS: 'CHAR_CLASS' });
function Oi(e, t, n, a) {
    const r = new RegExp(String.raw`${t}|(?<$skip>\[\^?|\\?.)`, 'gsu'),
        i = [!1];
    let s = 0,
        o = '';
    for (const c of e.matchAll(r)) {
        ...
        if (!u && (!a || (a === de.DEFAULT) == !s)) {
            n instanceof Function
                ? (o += n(c, {
                      context: s ? de.CHAR_CLASS : de.DEFAULT,
...
function mb(e, t, n = 0, a) {
    if (!new RegExp(t, 'su').test(e)) return null;
    const r = new RegExp(`${t}|(?<$skip>\\\\?.)`, 'gsu');
    r.lastIndex = n;
    let i = 0,
        s;
    for (; (s = r.exec(e)); ) {
        ...
        if (!c && (!a || (a === de.DEFAULT) == !i)) return s;
        (o === '[' ? i++ : o === ']' && i && i--,
            r.lastIndex == s.index && r.lastIndex++);
    }
    return null;
}
function Qn(e, t, n) {
...
const Ws = new RegExp(
    String.raw`(?<noncapturingStart>${ub})|(?<capturingStart>\((?:\?<[^>]+>)?)|\\?.`,
    'gsu',
);
function gb(e, t) {
    const n = t?.hiddenCaptures ?? [];
    let a = t?.captureTransfers ?? new Map();
    if (!/\(\?>/.test(e))
        return { pattern: e, captureTransfers: a, hiddenCaptures: n };
    const r = '(?>',
        i = '(?:(?=(',
        s = [0],
        o = [];
    ...
    do {
        ...
        let d = 0,
            ...
            v;
        for (
            Ws.lastIndex = Number.isNaN(u) ? 0 : u + i.length;
            (v = Ws.exec(e));
        ) {
            const {
                0: f,
                index: b,
                groups: { capturingStart: _, noncapturingStart: w },
            } = v;
            if (f === '[') d++;
            else if (d) f === ']' && d--;
            else if (f === r && !g) ((u = b), (g = !0));
            else if (g && w) m++;
            else if (_) g ? m++ : (c++, s.push(c + l));
            else if (f === ')' && g) {
                if (!m) {
                    l++;
                    const h = c + l;
                    if (
                        ((e = `${e.slice(0, u)}${i}${e.slice(u + r.length, b)}))<$$${h}>)${e.slice(b + 1)}`),
                        (p = !0),
                        o.push(h),
                        pb(n, h),
                        a.size)
    ...
    return (
        ...
        (e = Oi(
            ...
            ({ 0: d, groups: { backrefNum: m, wrappedBackrefNum: g } }) => {
                if (m) {
                    const v = +m;
                    if (v > s.length - 1)
                        throw new Error(
                            `Backref "${d}" greater than number of captures`,
                        );
                    return `\\${s[v]}`;
                }
                return `\\${g}`;
        ...
        { pattern: e, captureTransfers: a, hiddenCaptures: n }
    );
}
const El = String.raw`(?:[?*+]|\{\d+(?:,\d*)?\})`,
    nr = new RegExp(
        String.raw`
\\(?: \d+
  | c[A-Za-z]
...
| (?<qBase>${El})(?<qMod>[?+]?)(?<invalidQ>[?*+\{]?)
| \\?.
`.replace(/\s+/g, ''),
        'gsu',
    );
function fb(e) {
    if (!new RegExp(`${El}\\+`).test(e)) return { pattern: e };
    const t = [];
    let n = null,
        a = null,
        r = '',
        i = 0,
        s;
    for (nr.lastIndex = 0; (s = nr.exec(e)); ) {
        const {
            0: o,
            index: c,
            groups: { qBase: l, qMod: u, invalidQ: p },
        } = s;
        if (o === '[') (i || (a = c), i++);
        else if (o === ']') i ? i-- : (a = null);
        else if (!i)
            if (u === '+' && r && !r.startsWith('(')) {
                if (p) throw new Error(`Invalid quantifier "${o}"`);
                let d = -1;
                if (/^\{\d+\}$/.test(l)) e = db(e, c + l.length, u, '');
                else {
                    if (r === ')' || r === ']') {
                        const m = r === ')' ? n : a;
                        if (m === null)
                            throw new Error(`Invalid unmatched "${r}"`);
                        e = `${e.slice(0, m)}(?>${e.slice(m, c)}${l})${e.slice(c + o.length)}`;
                    } else
                        e = `${e.slice(0, c - r.length)}(?>${r}${l})${e.slice(c + o.length)}`;
                    d += 4;
                }
                nr.lastIndex += d;
            } else
                o[0] === '('
                    ? t.push(c)
                    : o === ')' && (n = t.length ? t.pop() : null);
        r = o;
    }
    return { pattern: e };
}
const ue = String.raw,
    bb = ue`\\g<(?<gRNameOrNum>[^>&]+)&R=(?<gRDepth>[^>]+)>`,
    Gr = ue`\(\?R=(?<rDepth>[^\)]+)\)|${bb}`,
    La = ue`\(\?<(?![=!])(?<captureName>[^>]+)>`,
    Fl = ue`${La}|(?<unnamed>\()(?!\?)`,
    Je = new RegExp(ue`${La}|${Gr}|\(\?|\\?.`, 'gsu'),
    ar = 'Cannot use multiple overlapping recursions';
function _b(e, t) {
    ...
    let r = t?.captureTransfers ?? new Map();
    if (!new RegExp(Gr, 'su').test(e))
        return { pattern: e, captureTransfers: r, hiddenCaptures: n };
    if (a === 'plugin' && Qn(e, ue`\(\?\(DEFINE\)`, de.DEFAULT))
        throw new Error('DEFINE groups cannot be used with recursion');
    const i = [],
        s = Qn(e, ue`\\[1-9]`, de.DEFAULT),
        o = new Map(),
        c = [];
    let l = !1,
        u = 0,
        p = 0,
        d;
    for (Je.lastIndex = 0; (d = Je.exec(e)); ) {
        const {
            0: m,
            groups: { captureName: g, rDepth: v, gRNameOrNum: f, gRDepth: b },
        } = d;
        if (m === '[') u++;
        else if (u) m === ']' && u--;
        else if (v) {
            if ((Vs(v), l)) throw new Error(ar);
            if (s)
                throw new Error(
                    `${a === 'external' ? 'Backrefs' : 'Numbered backrefs'} cannot be used with global recursion`,
                );
            const _ = e.slice(0, d.index),
                w = e.slice(Je.lastIndex);
            if (Qn(w, Gr, de.DEFAULT)) throw new Error(ar);
            const h = +v - 1;
            ((e = Zs(_, w, h, !1, n, i, p)), (r = Xs(r, _, h, i.length, 0, p)));
            break;
        } else if (f) {
            Vs(b);
            let _ = !1;
            for (const R of c)
                if (R.name === f || R.num === +f) {
                    if (((_ = !0), R.hasRecursedWithin)) throw new Error(ar);
                    break;
                }
            if (!_)
                throw new Error(
                    ue`Recursive \g cannot be used outside the referenced group "${a === 'external' ? f : ue`\g<${f}&R=${b}>`}"`,
                );
            const w = o.get(f),
                h = hb(e, w);
            if (s && Qn(h, ue`${La}|\((?!\?)`, de.DEFAULT))
                throw new Error(
                    `${a === 'external' ? 'Backrefs' : 'Numbered backrefs'} cannot be used with recursion of capturing groups`,
                );
            const C = e.slice(w, d.index),
                k = h.slice(C.length + m.length),
                $ = i.length,
                T = +b - 1,
                N = Zs(C, k, T, !0, n, i, p);
            r = Xs(r, C, T, i.length - $, $, p);
            const I = e.slice(0, w),
                D = e.slice(w + h.length);
            ((e = `${I}${N}${D}`),
                (Je.lastIndex += N.length - m.length - C.length - k.length),
                c.forEach((R) => (R.hasRecursedWithin = !0)),
                (l = !0));
        } else if (g)
            (p++,
                o.set(String(p), Je.lastIndex),
                o.set(g, Je.lastIndex),
                c.push({ num: p, name: g }));
        else if (m[0] === '(') {
            const _ = m === '(';
            (_ && (p++, o.set(String(p), Je.lastIndex)),
                c.push(_ ? { num: p } : {}));
        } else m === ')' && c.pop();
    }
    return (
...
function Zs(e, t, n, a, r, i, s) {
    ...
    const c = [n, a ? o : null, r, i, s];
    return `${e}${Ys(`(?:${e}`, 'forward', ...c)}(?:)${Ys(`${t})`, 'backward', ...c)}${t}`;
}
function Ys(e, t, n, a, r, i, s) {
    const c = (u) => (t === 'forward' ? u + 2 : n - u + 2 - 1);
    let l = '';
    for (let u = 0; u < n; u++) {
        const p = c(u);
        l += Oi(
            e,
            ue`${Fl}|\\k<(?<backref>[^>]+)>`,
            ({ 0: d, groups: { captureName: m, unnamed: g, backref: v } }) => {
                if (v && a && !a.has(v)) return d;
                const f = `_$${p}`;
                if (g || m) {
                    const b = s + i.length + 1;
                    return (i.push(b), yb(r, b), g ? d : `(?<${m}${f}>`);
                }
                return ue`\k<${v}${f}>`;
            },
            de.DEFAULT,
...
function Xs(e, t, n, a, r, i) {
    if (e.size && a) {
        let s = 0;
        Cl(t, Fl, () => s++, de.DEFAULT);
        const o = i - s + r,
            c = new Map();
        return (
            e.forEach((l, u) => {
                ...
                for (const v of l)
                    if (v <= o) g.push(v);
                    else if (v > o + s + p) g.push(v + a);
                    else if (v <= o + s)
                        for (let f = 0; f <= n; f++) g.push(v + s * f);
                    else for (let f = 0; f <= n; f++) g.push(v + d + p * f);
                c.set(m, g);
            }),
            c
        );
...
Le.bugFlagVLiteralHyphenIsRange = Le.unicodeSets
    ? (() => {
          try {
              new RegExp(j`[\d\-a]`, 'v');
          } catch {
    ...
    : !1;
Le.bugNestedClassIgnoresNegation =
    Le.unicodeSets && new RegExp('[[^a]]', 'v').test('a');
function xa(e, { enable: t, disable: n }) {
    return {
...
var Ks = { ES2025: 2025, ES2024: 2024, ES2018: 2018 },
    wb = { auto: 'auto', ES2025: 'ES2025', ES2024: 'ES2024', ES2018: 'ES2018' };
function $l(e = {}) {
    if ({}.toString.call(e) !== '[object Object]')
        throw new Error('Unexpected options');
    if (e.target !== void 0 && !wb[e.target])
...
var xb = '[	-\r ]',
    kb = new Set([V(304), V(305)]),
    Oe = j`[\p{L}\p{M}\p{N}\p{Pc}]`;
function jl(e) {
    if (kb.has(e)) return [e];
    const t = new Set(),
        n = e.toLowerCase(),
        a = n.toUpperCase(),
        r = Fb.get(n),
...
XID_Start XIDS`
    ...
    $b = new Map([
        ['alnum', j`[\p{Alpha}\p{Nd}]`],
        ['alpha', j`\p{Alpha}`],
        ['ascii', j`\p{ASCII}`],
        ['blank', j`[\p{Zs}\t]`],
        ['cntrl', j`\p{Cc}`],
        ['digit', j`\p{Nd}`],
        ['graph', j`[\P{space}&&\P{Cc}&&\P{Cn}&&\P{Cs}]`],
        ['lower', j`\p{Lower}`],
        ['print', j`[[\P{space}&&\P{Cc}&&\P{Cn}&&\P{Cs}]\p{Zs}]`],
        ['punct', j`[\p{P}\p{S}]`],
        ['space', j`\p{space}`],
        ['upper', j`\p{Upper}`],
        ['word', j`[\p{Alpha}\p{M}\p{Nd}\p{Pc}]`],
        ['xdigit', j`\p{AHex}`],
    ]);
function jb(e, t) {
    const n = [];
...
function Sb(e, t) {
    ...
    const a = {
        ...
        minTargetEs2024: Hr(n.bestEffortTarget, 'ES2024'),
        passedLookbehind: !1,
        strategy: null,
    ...
    pn(e, Ab, a);
    const r = { dotAll: e.flags.dotAll, ignoreCase: e.flags.ignoreCase },
        i = {
            currentFlags: r,
            prevFlags: null,
            globalFlags: r,
    ...
    return (
        pn(e, Rb, s),
        (e._originMap = i.groupOriginByCopy),
...
var Ab = {
        AbsenceFunction({ node: e, parent: t, replaceWith: n }) {
            ...
            if (r === 'repeater') {
                const i = be();
                i.body[0].body.push(at({ negate: !0, body: a }), Ft('Any'));
                const s = be();
                (s.body[0].body.push(wl('greedy', 0, 1 / 0, i)),
                    n(B(s, t), { traverse: !0 }));
            } else throw new Error('Unsupported absence function "(?~|"');
        },
        Alternative: {
            enter({ node: e, parent: t, key: n }, { flagDirectivesByAlt: a }) {
        ...
        Assertion(
            ...
            if (c === 'line_end')
                ...
                if (d.has(e)) ((r.flags.sticky = !0), i());
                else {
                    const g = a[n - 1];
                    if (g && Db(g)) s(B(at({ negate: !0 }), t));
                    else {
                        if (p)
                            throw new Error(
                                j`Uses "\G" in a way that requires a subclass`,
                            );
                        (s(Ue(zr('string_start'), t)),
                            (o.strategy = 'clip_search'));
                    }
                }
            else if (!(c === 'string_end' || c === 'string_start'))
                if (c === 'string_end_newline') s(B(Ie(j`(?=\n?\z)`), t));
        ...
        Backreference({ node: e }, { jsGroupNameMap: t }) {
            let { ref: n } = e;
            typeof n == 'string' && !sr(n) && ((n = ir(n, t)), (e.ref = n));
        },
        CapturingGroup(
            { node: e },
        ...
        CharacterSet(
            ...
            const { kind: c, negate: l, value: u } = e;
            if (i && (c === 'digit' || u === 'digit')) {
                n(Ue(Ur('digit', { negate: l }), t));
                return;
            }
            if (s && (c === 'space' || u === 'space')) {
                n(B(or(Ie(xb), l), t));
                return;
            }
            if (o && (c === 'word' || u === 'word')) {
                n(Ue(Ur('word', { negate: l }), t));
                return;
            }
            if (c === 'any') n(Ue(Ft('Any'), t));
            else if (c === 'digit') n(Ue(Ft('Nd', { negate: l }), t));
            else if (c !== 'dot')
                if (c === 'text_segment') {
                    if (a === 'strict')
                        throw new Error(
                            j`Use of "\X" requires non-strict accuracy`,
                        );
                    const p =
                    ...
                    n(
                        B(
                            Ie(
                                j`(?>\r\n|${r ? j`\p{RGI_Emoji}` : d}|\P{M}\p{M}*)`,
                                { skipPropertyNameValidation: !0 },
                            ),
                            t,
                        ),
                    );
                } else if (c === 'hex') n(Ue(Ft('AHex', { negate: l }), t));
                else if (c === 'newline')
                    n(
                        B(
                            Ie(
...
\v\f\u2028\u2029])`,
                    ...
                    if (!r && (u === 'graph' || u === 'print')) {
                        ...
                        let p = { graph: '!-~', print: ' -~' }[u];
                        (l &&
                            (p = `\0-${V(p.codePointAt(0) - 1)}${V(p.codePointAt(2) + 1)}-􏿿`),
                            n(B(Ie(`[${p}]`), t)));
                    } else n(B(or(Ie($b.get(u)), l), t));
                else if (c === 'property') Ii.has(Na(u)) || (e.key = 'sc');
                else if (c === 'space') n(Ue(Ft('space', { negate: l }), t));
                else if (c === 'word') n(B(or(Ie(Oe), l), t));
        ...
        Directive({
            ...
            removeAllNextSiblings: s,
        }) {
            const { kind: o, flags: c } = e;
            if (o === 'flags')
                if (!c.enable && !c.disable) a();
                else {
                    const l = be({ flags: c });
                    ((l.body[0].body = s()), r(B(l, t), { traverse: !0 }));
                }
            else if (o === 'keep') {
                const l = n.body[0],
                    p =
                        n.body.length === 1 &&
                        _l(l, { type: 'Group' }) &&
                        l.body[0].body.length === 1
                            ? l.body[0]
                            : n;
                if (t.parent !== p || p.body.length > 1)
                    throw new Error(j`Uses "\K" in a way that's unsupported`);
                const d = at({ behind: !0 });
                ((d.body[0].body = i()), r(B(d, t)));
        ...
        NamedCallout({ node: e, parent: t, replaceWith: n }) {
            const { kind: a } = e;
            if (a === 'fail') n(B(at({ negate: !0 }), t));
            else
                throw new Error(
                    `Unsupported named callout "(*${a.toUpperCase()}"`,
                );
        },
        Quantifier({ node: e }) {
            if (e.body.type === 'Quantifier') {
                const t = be();
                (t.body[0].body.push(e.body), (e.body = B(t, e)));
            }
        },
        Regex: {
            enter({ node: e }, { supportedGNodes: t }) {
                ...
                a && !r && n.forEach((i) => t.add(i));
            },
            exit(e, { accuracy: t, passedLookbehind: n, strategy: a }) {
                if (t === 'strict' && n && a)
                    throw new Error(
                        j`Uses "\G" in a way that requires non-strict accuracy`,
                    );
            },
        },
    ...
    Tb = {
        Backreference(
            ...
            a || n.set(e, [...t.get(r).map(({ node: i }) => i)]);
        },
        CapturingGroup: {
            enter(
                { node: e, parent: t, replaceWith: n, skip: a },
                {
                    groupOriginByCopy: r,
                    groupsByName: i,
                ...
                const l = r.get(e);
                if (l && o.has(e.number)) {
                    const p = Ue(Qs(e.number), t);
                    (c.set(p, o.get(e.number)), n(p));
                    return;
                }
                (o.set(e.number, e),
                    s.set(e.number, []),
                ...
                if (
                    (s.get(e.number).push({ node: e, origin: l }),
                    e.name && s.get(e.name).push({ node: e, origin: l }),
                    e.name)
                ) {
                    const p = yn(i, e.name, new Map());
                    let d = !1;
                    if (l) d = !0;
                    else
        ...
        Group: {
            enter({ node: e }, t) {
                ((t.prevFlags = t.currentFlags),
                    e.flags && (t.currentFlags = xa(t.currentFlags, e.flags)));
            },
            exit(e, t) {
                t.currentFlags = t.prevFlags;
            },
        },
        Subroutine({ node: e, parent: t, replaceWith: n }, a) {
            ...
            const s = a.subroutineRefMap.get(i),
                o = i === 0,
                c = o ? Qs(0) : Tl(s, a.groupOriginByCopy, null);
            let l = c;
            if (!o) {
                const u = Rl(Nb(s, (d) => d.type === 'Group' && !!d.flags)),
                    p = u ? xa(a.globalFlags, u) : a.globalFlags;
                Ob(p, a.currentFlags) ||
                    ((l = be({ flags: Lb(p) })), l.body[0].body.push(c));
            }
            n(B(l, t), { traverse: !o });
        },
    },
    Rb = {
        Backreference({ node: e, parent: t, replaceWith: n }, a) {
            if (e.orphan) {
                a.highestOrphanBackref = Math.max(
                    a.highestOrphanBackref,
                    e.ref,
                );
                return;
            }
            const i = a.reffedNodesByReferencer.get(e).filter((s) => Ib(s, e));
            if (!i.length) n(B(at({ negate: !0 }), t));
            else if (i.length > 1) {
                const s = be({
                    atomic: !0,
                    body: i.reverse().map((o) => ht({ body: [Br(o.number)] })),
                });
                n(B(s, t));
...
function ir(e, t) {
    ...
    const n = `$${t.size}_${e.replace(/^[^$_\p{IDS}]|[^$\u200C\u200D\p{IDC}]/gu, '_')}`;
    return (t.set(e, n), n);
}
function Rl(e) {
    const t = ['dotAll', 'ignoreCase'],
        n = { enable: {}, disable: {} };
    return (
        e.forEach(({ flags: a }) => {
            t.forEach((r) => {
                (a.enable?.[r] && (delete n.disable[r], (n.enable[r] = !0)),
                    a.disable?.[r] && (n.disable[r] = !0));
            });
        }),
...
function Lb({ dotAll: e, ignoreCase: t }) {
    const n = {};
    return (
        (e || t) &&
            ((n.enable = {}),
...
function Il(e) {
    const t = e.find(
        (n) => n.kind === 'search_start' || Mb(n, { negate: !1 }) || !Pb(n),
    );
    if (!t) return null;
...
function Nl(e, t) {
    const n = Ol(e) ?? [];
    for (const a of n) if (a === t || Nl(a, t)) return !0;
    return !1;
}
function Pb({ type: e }) {
    return (
...
function Mb(e, t) {
    ...
    return (
        ...
        e.body.length === 1 &&
        _l(e.body[0], { type: 'Assertion', kind: 'search_start' })
    );
}
function sr(e) {
...
function Ie(e, t) {
    const a = yl(e, { ...t, unicodePropertyMap: Ii }).body;
    return a.length > 1 || a[0].body.length > 1
        ? be({ body: a })
        : a[0].body[0];
}
function or(e, t) {
...
function B(e, t) {
    return (Al(e), (e.parent = t), e);
}
function qb(e, t) {
    const n = $l(t),
        a = Hr(n.target, 'ES2024'),
        r = Hr(n.target, 'ES2025'),
        i = n.rules.recursionLimit;
    ...
    function p(m) {
        return (
            (u.lastNode = l),
            (l = m),
            vb(Bb[m.type], `Unexpected node type "${m.type}"`)(m, u, p)
        );
    }
    const d = {
    ...
    return (
        a ||
            ...
            (d.options.disable.v = !0),
            (d.options.unicodeSetsPlugin = null)),
        (d._captureTransfers = new Map()),
        (d._hiddenCaptures = []),
        u.captureMap.forEach((m, g) => {
            (m.hidden && d._hiddenCaptures.push(g),
                m.transferTo &&
                    yn(d._captureTransfers, m.transferTo, []).push(g));
        }),
        d
    );
}
var zb = {
        '*': {
            enter({ node: e }, t) {
                if (eo(e)) {
                    ...
                    t.pushModI(
                        e.flags ? xa({ ignoreCase: n }, e.flags).ignoreCase : n,
                    );
                }
            },
            exit({ node: e }, t) {
        ...
        Character({ node: e }, t) {
            Ni(V(e.value)) && t.setHasCasedChar();
        },
        CharacterClassRange({ node: e, skip: t }, n) {
            (t(), Ll(e, { firstOnly: !0 }).length && n.setHasCasedChar());
        },
        CharacterSet({ node: e }, t) {
            e.kind === 'property' && Sl.has(e.value) && t.setHasCasedChar();
        },
    },
    Bb = {
        ...
        Assertion({ kind: e, negate: t }) {
            ...
            if (e === 'word_boundary') return t ? j`\B` : j`\b`;
        ...
        CapturingGroup(e, t, n) {
            const { body: a, name: r, number: i } = e,
                s = { ignoreCase: t.currentFlags.ignoreCase },
                o = t.originMap.get(e);
            return (
                o &&
                    ((s.hidden = !0),
                    i > o.number && (s.transferTo = o.number)),
                t.captureMap.set(i, s),
                `(${r ? `?<${r}>` : ''}${a.map(n).join('|')})`
            );
        },
        Character({ value: e }, t) {
            ...
            if (a !== n) return a;
            if (t.useAppliedIgnoreCase && t.currentFlags.ignoreCase && Ni(n)) {
                const r = jl(n);
        ...
        CharacterClass(e, t, n) {
            ...
            let { body: s } = e;
            if (a === 'intersection' && !t.useFlagV)
                throw new Error(
                    'Use of class intersection requires min target ES2024',
                );
            Le.bugFlagVLiteralHyphenIsRange &&
                t.useFlagV &&
                s.some(to) &&
                (s = [Ia(45), ...s.filter((l) => !to(l))]);
            const o = () =>
                `[${r ? '^' : ''}${s.map(n).join(a === 'intersection' ? '&&' : '')}]`;
            if (!t.inCharClass) {
                if ((!t.useFlagV || Le.bugNestedClassIgnoresNegation) && !r) {
                    const u = s.filter(
                        (p) =>
                            p.type === 'CharacterClass' &&
                            p.kind === 'union' &&
                            p.negate,
                    );
                    if (u.length) {
                        ...
                        return (
                            (p.parent = i),
                            (d.parent = p),
                            (s = s.filter((m) => !u.includes(m))),
                            (e.body = s),
                            s.length
                                ? ((e.parent = d), d.body.push(e))
                                : p.body.pop(),
                            u.forEach((m) => {
                                const g = ht({ body: [m] });
                                ((m.parent = g),
            ...
            if (
                ...
                (((!t.useFlagV || !t.verbose) &&
                    i.kind === 'union' &&
                    !(Le.bugFlagVLiteralHyphenIsRange && t.useFlagV)) ||
                    (!t.verbose &&
                        i.kind === 'intersection' &&
                        s.length === 1 &&
                ...
                return s.map(n).join('');
            if (!t.useFlagV && i.type === 'CharacterClass')
                throw new Error(
                    'Use of nested character class requires min target ES2024',
                );
            return o();
        },
        CharacterClassRange(e, t) {
            const n = e.min.value,
                a = e.max.value,
                r = { escDigit: !1, inCharClass: !0, useFlagV: t.useFlagV },
                i = kt(n, r),
                s = kt(a, r),
                o = new Set();
        ...
        CharacterSet({ kind: e, negate: t, value: n, key: a }, r) {
            if (e === 'dot')
                return r.currentFlags.dotAll
                    ? r.appliedGlobalFlags.dotAll || r.useFlagMods
                        ? '.'
                        : '[^]'
                    : j`[^\n]`;
            if (e === 'digit') return t ? j`\D` : j`\d`;
            if (e === 'property') {
                if (
                    r.useAppliedIgnoreCase &&
                    r.currentFlags.ignoreCase &&
                    Sl.has(n)
                )
                    throw new Error(
                        `Unicode property "${n}" can't be case-insensitive when other chars have specific case`,
                    );
                return `${t ? j`\P` : j`\p`}{${a ? `${a}=` : ''}${n}}`;
            }
            if (e === 'word') return t ? j`\W` : j`\w`;
        ...
        Group({ atomic: e, body: t, flags: n, parent: a }, r, i) {
            const s = r.currentFlags;
            n && (r.currentFlags = xa(s, n));
            const o = t.map(i).join('|'),
                c =
                    !r.verbose &&
                    t.length === 1 &&
                    a.type !== 'Quantifier' &&
                    ...
                    (!r.useFlagMods || !n)
                        ? o
                        : `(?${Zb(e, n, r.useFlagMods)}${o})`;
            return ((r.currentFlags = s), c);
        },
        LookaroundAssertion({ body: e, kind: t, negate: n }, a, r) {
            return `(?${`${t === 'lookahead' ? '' : '<'}${n ? '!' : '='}`}${e.map(r).join('|')})`;
        },
        Quantifier(e, t, n) {
            return n(e.body) + Yb(e);
        },
...
function Ll(e, t) {
    ...
    for (let s = a; s <= r; s++) {
        const o = V(s);
        if (!Ni(o)) continue;
        const c = jl(o).filter((l) => {
            const u = l.codePointAt(0);
            return u < a || u > r;
        });
        if (c.length && (i.push(...c), n)) break;
    }
    return i;
}
function kt(e, { escDigit: t, inCharClass: n, useFlagV: a }) {
    if (Js.has(e)) return Js.get(e);
    if (e < 32 || (e > 126 && e < 160) || e > 262143 || (t && Xb(e)))
        return e > 255
            ? `\\u{${e.toString(16).toUpperCase()}}`
            : `\\x${e.toString(16).toUpperCase().padStart(2, '0')}`;
    const r = n ? (a ? Hb : Gb) : Ub,
        i = V(e);
    return (r.has(i) ? '\\' : '') + i;
}
function Vb(e) {
    const t = e.map((r) => r.codePointAt(0)).sort((r, i) => r - i),
        n = [];
    let a = null;
...
function Yb({ kind: e, max: t, min: n }) {
    let a;
    return (
        !n && t === 1
            ? (a = '?')
...
function to({ type: e, value: t }) {
    return e === 'Character' && t === 45;
}
var Kb = class Wr extends RegExp {
    #t = new Map();
    #e = null;
    #a;
    #n = null;
    ...
    constructor(t, n, a) {
        ...
        if (t instanceof RegExp) {
            ...
            (super(r ? '' : t, n),
                (this.#a = t),
                (this.#t = Jb(i.hiddenCaptures, i.transfers)),
                (this.#r = i.strategy),
                (this.rawOptions = a ?? {}));
        }
        r || (this.#e = this);
    ...
    exec(t) {
        if (!this.#e) {
            const { lazyCompile: r, ...i } = this.rawOptions;
            this.#e = new Wr(this.#a, this.flags, i);
        }
        const n = this.global || this.sticky,
            a = this.lastIndex;
        if (this.#r === 'clip_search' && n && a) {
            this.lastIndex = 0;
            const r = this.#i(t.slice(a));
            return (
                r && (Qb(r, a, t, this.hasIndices), (this.lastIndex += a)),
                r
            );
        }
        return this.#i(t);
    ...
    #i(t) {
        ...
        const n = super.exec.call(this.#e, t);
        ...
        for (let s = 1; s < a.length; s++) {
            const { hidden: o, transferTo: c } = this.#t.get(s) ?? {};
            if (
                (o
                    ? i.push(null)
                    : (i.push(n.length),
                      n.push(a[s]),
                      this.hasIndices && n.indices.push(r[s])),
                c && a[s] !== void 0)
            ) {
                const l = i[c];
                ...
                if (
                    ((n[l] = a[s]),
                    this.hasIndices && (n.indices[l] = r[s]),
                    n.groups)
                ) {
                    this.#n || (this.#n = e_(this.source));
                    const u = this.#n.get(c);
                    u &&
                        ((n.groups[u] = a[s]),
                        this.hasIndices && (n.indices.groups[u] = r[s]));
                }
            }
        }
        return n;
...
function Jb(e, t) {
    const n = new Map();
    for (const a of e) n.set(a, { hidden: !0 });
    for (const [a, r] of t) for (const i of r) yn(n, i, {}).transferTo = a;
    return n;
}
function e_(e) {
    ...
    for (; (i = t.exec(e)); ) {
        const {
            0: s,
            groups: { capture: o, name: c },
        } = i;
        s === '[' ? a++ : a ? s === ']' && a-- : o && (r++, c && n.set(r, c));
    }
    return n;
}
function t_(e, t) {
    const n = n_(e, t);
    return n.options
        ? new Kb(n.pattern, n.flags, n.options)
...
function n_(e, t) {
    ...
    if (n.avoidSubclass) {
        ...
        const u = c.hiddenCaptures.sort((g, v) => g - v),
            p = Array.from(c.captureTransfers),
            d = r._strategy,
            m = l.pattern.length >= n.lazyCompileLength;
        (u.length || p.length || d || m) &&
            (l.options = {
...
class a_ {
    constructor(t, n = {}) {
        ((this.patterns = t), (this.options = n));
        const { forgiving: a = !1, cache: r, regexConstructor: i } = n;
        if (!i) throw new Error('Option `regexConstructor` is not provided');
        this.regexps = t.map((s) => {
            ...
            try {
                ...
                if ((r?.set(s, c), a)) return null;
                throw c;
            }
        });
    }
    regexps;
    findNextMatchSync(t, n, a) {
        const r = typeof t == 'string' ? t : t.content,
            i = [];
        function s(o, c, l = 0) {
            return {
                index: o,
        ...
        for (let o = 0; o < this.regexps.length; o++) {
            const c = this.regexps[o];
            if (c)
                try {
                    c.lastIndex = n;
                    const l = c.exec(r);
                    if (!l) continue;
                    if (l.index === n) return s(o, l, 0);
                    i.push([o, l, 0]);
                } catch (l) {
        ...
        if (i.length) {
            const o = Math.min(...i.map((c) => c[1].index));
            for (const [c, l, u] of i) if (l.index === o) return s(c, l, u);
        }
        return null;
    }
}
...
function i_(e = {}) {
    const t = Object.assign({ target: 'auto', cache: new Map() }, e);
    return (
        (t.regexConstructor ||= (n) => r_(n, { target: t.target })),
        {
            createScanner(n) {
                return new a_(n, t);
            },
...
const v_ = yf({ themes: [y_, __], langs: [b_, ql, Pl], engine: i_() });
                ...
                line(s, o) {
                    ...
                    const c = r + o - 1,
                        ...
                        u = {
                            ...
                            children: [{ type: 'text', value: c.toString() }],
                        };
                    (s.children.unshift(u),
                        this.addClassToHast(s, [
                            ...
                            l ? 'bg-rose-200! dark:bg-rose-900!' : '',
                        ]));
                },
            },
        ],
