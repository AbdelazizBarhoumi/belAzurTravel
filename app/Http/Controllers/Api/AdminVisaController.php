...
class AdminVisaController extends Controller
{
    ...
    private function attributes(Request $request, ?Visa $existing = null): array
    {
        $data = $request->validate([
            ...
            'region_fr' => 'required|string|max:255',
            'region_ar' => 'required|string|max:255',
            'processing_en' => 'required|string|max:255',
            'processing_fr' => 'required|string|max:255',
            'processing_ar' => 'required|string|max:255',
        ...
        return [
            ...
            'flag' => $data['flag'],
            'region' => ['en' => $data['region_en'], 'fr' => $data['region_fr'], 'ar' => $data['region_ar']],
    ...
    private function adminPayload(Visa $item): array
    {
        return [
            ...
            'region_fr' => $item->region['fr'] ?? '',
            'region_ar' => $item->region['ar'] ?? '',
