...
class AdminHotelController extends Controller
{
    ...
    private function attributes(Request $request, ?Model $existing = null): array
    {
        ...
        $rules = [
            ...
            // Filter fields
            'htel_recommande' => ['sometimes', 'boolean'],
            'tarifs_promo' => ['sometimes', 'boolean'],
            'enfant_gratuit' => ['sometimes', 'boolean'],
            'disponible_seulement' => ['sometimes', 'boolean'],
            'annulation_gratuite' => ['sometimes', 'boolean'],
            'logement_simple' => ['sometimes', 'boolean'],
            'petit_dejeuner' => ['sometimes', 'boolean'],
            'demi_pension' => ['sometimes', 'boolean'],
            'pension_complete' => ['sometimes', 'boolean'],
            'categorie_4_etoiles' => ['sometimes', 'boolean'],
            'chambre_double' => ['sometimes', 'boolean'],
            'suite' => ['sometimes', 'boolean'],
            'chambre_standard' => ['sometimes', 'boolean'],
            'suite_junior' => ['sometimes', 'boolean'],
            'thalasso_spa' => ['sometimes', 'boolean'],
            'nature_aventure' => ['sometimes', 'boolean'],
            'famille' => ['sometimes', 'boolean'],
            'affaires' => ['sometimes', 'boolean'],
            'sport_loisir' => ['sometimes', 'boolean'],
            'detente' => ['sometimes', 'boolean'],
