...
class BookingActivityNotification extends Notification
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        $subject = $translate("{$group}.subject", ['id' => $this->booking->booking_ref ?: $this->booking->id, 'client' => $client]);
        ...
        $data = [
            ...
            'introLine' => $translate("{$group}.intro", ['id' => $this->booking->booking_ref ?: $this->booking->id, 'client' => $client]),
